...
namespace Agronomico.WebForms.App_Code.Administracion
{
    public class CListaPrecios
    {
        ...
        public decimal SeleccionaPrecioNovedadAñoTerceroJerarquia(int empresa, string novedad, int tercero, DateTime fechaNovedad, string jerarquia)
        {
            string[] iParametros = new string[] { "@empresa", "@novedad", "@tercero", "@fechaNovedad", "@jerarquia" };
            string[] oParametros = new string[] { "@precio" };
            object[] objValores = new object[] { empresa, novedad, tercero, fechaNovedad, jerarquia };
            return Convert.ToDecimal(Cacceso.ExecProc("spSeleccionaPrecioNovedadAñoTerceroJerarquia", iParametros, oParametros, objValores, "ppa").GetValue(0));
        }


        public decimal SeleccionaPrecioNovedadAñoTercero(int empresa, string novedad, int año, string tercero, DateTime fechaNovedad)
        {
        ...
        public int EjecutaReplicacionPrecioLabores(int empresa, int añoAnterior, int añoActual, string usuario)
        {
            string[] iParametros = new string[] { "@empresa", "@añoAnterior", "@añoActual", "@usuario" };
            string[] oParametros = new string[] { "@retorno" };
            object[] objValores = new object[] { empresa, añoAnterior, añoActual, usuario };

            return Convert.ToInt32(Cacceso.ExecProc("spReplicaPrecioLaboresAños", iParametros, oParametros, objValores, "ppa").GetValue(0));
        }
    }
}