<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnidadMedida.aspx.cs" Inherits="Agronomico.WebForms.Formas.Padministracion.UnidadMedida" %>
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:TextBox ID="txtCodigo" runat="server"  Width="150px" AutoPostBack="True" OnTextChanged="txtConcepto_TextChanged" CssClass="input" MaxLength="50" Visible="False"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:TextBox ID="txtDescripcionCorta" runat="server"  Width="150px" CssClass="input" MaxLength="3" Visible="False"></asp:TextBox></td>
                    <td ></td>
                </tr>
                <tr>
                    <td ></td>
