...
{
    public partial class GrupoLabor : BasePage
    {
        #region Instancias
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("aGrupoNovedad", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("aGrupoNovedad", "elimina", "ppa", objValores))
                {
                    case 0:
        ...
        protected void lbRegistrar_Click(object sender, EventArgs e)
        {
            if (chkManejaCcostoSiigo.Checked)
            {
                ...
                {
                    CerroresGeneral.ManejoError(this, GetType(), "Debe seleccionar un Centro de costo de Siigo", "warning");
                    return;
                }
            }
