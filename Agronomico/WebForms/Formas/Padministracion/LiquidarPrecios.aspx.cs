...
{
    public partial class LiquidarPrecios : BasePage
    {
        ...
        private void Preliquidar()
        {
            ...
            int retorno = 0;
            retorno = tran.ReliquidaPreciosLabores(Convert.ToInt32(this.Session["empresa"]), Convert.ToDateTime(txtFechaInicio.Text), Convert.ToDateTime(txtFechaFinal.Text), this.Session["usuario"].ToString());
            switch (retorno)
            {
                case 1:
