<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Seccion.aspx.cs" Inherits="Agronomico.WebForms.Formas.Padministracion.Seccion" %>
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlFinca" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="350px"  AutoPostBack="True" OnSelectedIndexChanged="ddlFinca_SelectedIndexChanged" Visible="False">
                        </asp:DropDownList>
                    </td>
                    <td ></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:TextBox ID="txtCodigo" runat="server"  Width="150px" AutoPostBack="True" OnTextChanged="txtConcepto_TextChanged" CssClass="input" MaxLength="3" Visible="False"></asp:TextBox></td>
                    <td ></td>
                </tr>
                <tr>
                    <td ></td>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:TextBox ID="txtDescripcion" runat="server"  Width="350px" CssClass="input" MaxLength="550" Visible="False"></asp:TextBox>
                    </td>
                    <td ></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:TextBox ID="txtHectareas" runat="server"  Width="150px" CssClass="input" ValidateRequestMode="Enabled" ViewStateMode="Enabled" onkeyup="formato_numero(this)" Visible="False"></asp:TextBox>
                    </td>
                    <td ></td>
                </tr>
                <tr>
