...
{
    public partial class TipoCanal : BasePage
    {
        #region Instancias
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("aTipoCanal", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
            ...
            else
            {
                try
                {
                   ...
                   Convert.ToInt32(Session["empresa"])
                    ...
                    switch (CentidadMetodos.EntidadInsertUpdateDelete("aTipoCanal", operacion, "ppa", objValores))
                    {
                        case 0:
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("aTipoCanal", "elimina", "ppa", objValores))
                {
                    case 0:
