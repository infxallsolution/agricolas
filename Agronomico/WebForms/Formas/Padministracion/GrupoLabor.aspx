<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrupoLabor.aspx.cs" Inherits="Agronomico.WebForms.Formas.Padministracion.GrupoLabor" %>
        ...
        <form id="form1" runat="server">
            ...
            <table style="width: 100%" id="tdCampos">
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:TextBox ID="txtDescripcion" runat="server"  Width="350px" CssClass="input" MaxLength="550" Visible="False"></asp:TextBox></td>
                    <td ></td>
                </tr>
                <tr>
                    <td ></td>
                    <td style="text-align: left; width: 160px">
                        <asp:Label ID="lblDepartamento39" runat="server" Text="Centro costo" Visible="False" ></asp:Label>
                    </td>
                    <td style="text-align: left; width: 400px">
                ...
                <tr>
                    <td ></td>
                    <td style="text-align: left; width: 160px">
                        <asp:CheckBox CssClass="checkbox checkbox-primary" ID="chkManejaCcostoSiigo" runat="server" Text="Centro costo Alterno"  AutoPostBack="True" OnCheckedChanged="chkManejaCcostoSiigo_CheckedChanged" Visible="False" />
                    </td>
                    <td style="text-align: left; width: 400px">
