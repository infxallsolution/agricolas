<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoCanal.aspx.cs" Inherits="Agronomico.WebForms.Formas.Padministracion.TipoCanal" %>
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:TextBox ID="txtCodigo" runat="server"  Width="150px" AutoPostBack="True" OnTextChanged="txtConcepto_TextChanged" CssClass="input" Visible="False"></asp:TextBox></td>
                    <td ></td>
                </tr>
                <tr>
                    <td ></td>
