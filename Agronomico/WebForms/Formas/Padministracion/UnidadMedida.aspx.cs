...
{
    public partial class UnidadMedida : BasePage
    {
        #region Instancias
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("gUnidadMedida", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("gUnidadMedida", "elimina", "ppa", objValores))
                {
                    case 0:
