...
namespace Nomina.WebForms.App_Code.General
{
    public class CcontrolesUsuario
    {
        ...
        static public string FormatoCifras(decimal cifra)
        {
            string texto = "";
            CultureInfo cultura = new CultureInfo(CultureInfo.CurrentCulture.ToString());

            try
            {
                texto = cifra.ToString("#" + cultura.NumberFormat.NumberGroupSeparator + "##0" + cultura.NumberFormat.NumberDecimalSeparator +
                    "".PadLeft(cultura.NumberFormat.NumberDecimalDigits, '0'));
            }
            catch
            {
            }
            ...
            if (!(texto.Contains(".") && texto.Contains(",")))
            {
                if (texto.Length > 0)
                {
                    if (texto.Contains("."))
                    {
                        if (cultura.NumberFormat.NumberDecimalSeparator.Trim() == ",")
                            texto = texto.Replace('.', ',');
                    }
                    ...
                    if (parentControl.ID != null)
                    {
                        ...
                        if (Convert.ToString(objCampo.GetValue(0)).Trim().Length != 0)
                        {
                            ...
                            else if (parentControl is TextBox)
                            {
                                ...
                                if (((Label)parentControl.FindControl(Convert.ToString(parentControl.ID).Trim().Replace(Convert.ToString(parentControl.ID).Substring(0, 3), "lbl")) != null))
                                {
                                    ...
                                    ((Label)parentControl.FindControl(Convert.ToString(parentControl.ID).Trim().Replace(Convert.ToString(parentControl.ID).Substring(0, 3), "lbl"))).Enabled = true;
                                }
                                else
                                {
                                    if (((LinkButton)parentControl.FindControl(Convert.ToString(parentControl.ID).Trim().Replace(Convert.ToString(parentControl.ID).Substring(0, 3), "lb"))) != null)
                                    {
                                        ...
                                        ((LinkButton)parentControl.FindControl(Convert.ToString(parentControl.ID).Trim().Replace(Convert.ToString(parentControl.ID).Substring(0, 3), "lb"))).Enabled = true;
                                    }
                        ...
                        else
                        {
                            if (parentControl is CheckBox)
                            {
                                ...
                                ((CheckBox)parentControl).Visible = false;
                            ...
                            if (parentControl is DropDownList)
                            {
                                ...
                                ((DropDownList)parentControl).Visible = false;

                                if (((Label)parentControl.FindControl(Convert.ToString(parentControl.ID).Trim().Replace(Convert.ToString(parentControl.ID).Substring(0, 3), "lbl")) != null))
                                {
                                    ((Label)parentControl.FindControl(Convert.ToString(parentControl.ID).Trim().Replace(Convert.ToString(parentControl.ID).Substring(0, 3), "lbl"))).Enabled = false;

                                    ((Label)parentControl.FindControl(Convert.ToString(parentControl.ID).Trim().Replace(Convert.ToString(parentControl.ID).Substring(0, 3), "lbl"))).Visible = false;
                                }
                            }

                            if (parentControl is TextBox)
                            {
                                ((TextBox)parentControl).Enabled = false;
                                ((TextBox)parentControl).Visible = false;
                                ...
                                if (((LinkButton)parentControl.FindControl(Convert.ToString(parentControl.ID).Trim().Replace(Convert.ToString(parentControl.ID).Substring(0, 3), "lb")) != null))
                                {
                                    ...
                                    ((LinkButton)parentControl.FindControl(Convert.ToString(parentControl.ID).Trim().Replace(Convert.ToString(parentControl.ID).Substring(0, 3), "lb"))).Enabled = false;

                                    ((LinkButton)parentControl.FindControl(Convert.ToString(parentControl.ID).Trim().Replace(Convert.ToString(parentControl.ID).Substring(0, 3), "lb"))).Visible = false;
