...
{
    public class CinformacionAcademica
    {
        public CinformacionAcademica()
        {
            //
        ...
        {
            DataView dvEntidad = CentidadMetodos.EntidadGet("nFormacionAcadamica", "ppa").Tables[0].DefaultView;
        ...
        public DataView RetornaDatosProspecto(string tercero, int contrato, int empresa, int registro)
        {
            ...
            return Cacceso.DataSetParametros("SpGetnFormacionAcadamicakey", iParametros, objValores, "ppa").Tables[0].DefaultView;
        }
