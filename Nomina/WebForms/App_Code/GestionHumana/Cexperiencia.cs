...
namespace Nomina.WebForms.App_Code.GestionHumana
{
    public class Cexperiencia
    {
        ...
        {
            DataView dvEntidad = CentidadMetodos.EntidadGet("nExperienciaLaboral", "ppa").Tables[0].DefaultView;
        ...
        public DataView RetornaDatosProspecto(string tercero, int contrato, int empresa, int registro)
        {
            ...
            return Cacceso.DataSetParametros("SpGetnExperienciaLaboralkey", iParametros, objValores, "ppa").Tables[0].DefaultView;
        }
