...
{
    public partial class Vacaciones2 : BasePage
    {
        #region Instancias
        ...
        private void Guardar()
        {
            ...
            try
            {
                using (TransactionScope ts = new TransactionScope())
                {
                    ...
                    switch (vacaciones.AcumulaVacaciones(empresa: Convert.ToInt32(this.Session["empresa"]), empleado: Convert.ToInt16(ddlEmpleado.SelectedValue.Trim()), año: Convert.ToInt32(ddlAño.SelectedValue),
        ...
        private void manejoLiquidaVaca()
        {
            ...
            else
            {
                ...
                {
                    txvValorBase.Text = vacaciones.RetornaBaseVariableVacaciones(Convert.ToInt16(this.Session["empresa"]), Convert.ToInt16(ddlEmpleado.SelectedValue.Trim()), Convert.ToDateTime(txtFecha.Text)).ToString();
