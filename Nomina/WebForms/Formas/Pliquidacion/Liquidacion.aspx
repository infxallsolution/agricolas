<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Liquidacion.aspx.cs" Inherits="Nomina.WebForms.Formas.Pliquidacion.Liquidacion" %>
        ...
        <form id="form1" runat="server">
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="width: 120px; text-align: left;">
                        <asp:Label ID="lbFecha" runat="server" 
                            Visible="False" >Fecha liquidación</asp:Label></td>
                    <td class="Campos">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlPeriodo" runat="server" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..." Visible="False" Width="95%" AutoPostBack="True" OnSelectedIndexChanged="ddlPeriodo_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 120px; text-align: left;">
                    ...
                    <td style="width: 400px; text-align: left;">
                        <asp:DropDownList ID="ddlOpcionLiquidacion" runat="server" AutoPostBack="True" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..." Visible="False" Width="95%" OnSelectedIndexChanged="ddlOpcionLiquidacion_SelectedIndexChanged">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlccosto" runat="server" AutoPostBack="True" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..." OnSelectedIndexChanged="ddlccosto_SelectedIndexChanged" Visible="False" Width="95%">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 120px; text-align: left;">
                    ...
                    <td style="width: 400px; text-align: left;">
                        <asp:DropDownList ID="ddlEmpleado" runat="server" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..." Visible="False" Width="95%">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 15%"></td>
                </tr>
