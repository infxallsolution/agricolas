<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiquidacionContrato2.aspx.cs" Inherits="Nomina.WebForms.Formas.Pliquidacion.LiquidacionContrato2" %>
            ...
            <table style="width: 100%" id="tdCampos">
                ...
                <tr>
                    ...
                    <td colspan="3" style="text-align: left">
                        <asp:DropDownList ID="ddlEmpleado" runat="server" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opciÃ³n..." Visible="False" Width="95%" AutoPostBack="True" OnSelectedIndexChanged="ddlEmpleado_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td></td>
                </tr>
                ...
                <tr>
                    <td></td>
                    <td style="width: 120px; text-align: left;">
                        <asp:Label ID="lblano" runat="server" Text="Año" Visible="False"></asp:Label>
                    </td>
                    <td style="text-align: left; width: 250px;">
                        <asp:DropDownList ID="ddlAno" runat="server" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..." Visible="False" Width="80%" AutoPostBack="True" OnSelectedIndexChanged="ddlAno_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
