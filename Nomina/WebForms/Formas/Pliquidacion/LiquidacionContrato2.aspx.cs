...
{
    public partial class LiquidacionContrato2 : BasePage
    {
        ...
        private void cargarLiquidacion()
        {
            ...
            if (ddlAno.Visible == true)
            {
                año = Convert.ToInt16(ddlAno.SelectedValue);
        ...
        {
            if (ddlPeriodo.SelectedValue.Trim().Length > 0 & ddlAno.SelectedValue.Trim().Length > 0)
        ...
        protected void cargarPeriodos()
        {
            try
            {
                this.ddlPeriodo.DataSource = periodo.PeriodosAbiertoNominaAño(Convert.ToInt32(ddlAno.SelectedValue.Trim()), Convert.ToInt16(Session["empresa"])).Tables[0].DefaultView;
        ...
        private void CargarCombos()
        {
            try
            {
                this.ddlAno.DataSource = periodo.PeriodoAñoAbiertoNomina(Convert.ToInt16(Session["empresa"]));
                this.ddlAno.DataValueField = "año";
                this.ddlAno.DataTextField = "año";
        ...
        private void Liquidar()
        {
            ...
            switch (retorno)
            {
                case 1:
                    ...
                    break;
                case 2:
                    MostrarMensaje("El funcionario ya tiene una liquidacion");
                    break;
                case 0:
        ...
        protected void btnLiquidar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddlAno.SelectedValue.Trim().Length == 0)
                {
