<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vacaciones.aspx.cs" Inherits="Nomina.WebForms.Formas.Pliquidacion.Vacaciones" %>
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="text-align: left" colspan="2">
                        <asp:DropDownList ID="ddlAño" runat="server" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..." Visible="False" Width="160px" AutoPostBack="True" OnSelectedIndexChanged="ddlAño_SelectedIndexChanged1">
                        </asp:DropDownList>
                        <asp:CheckBox ID="chkPromedio" runat="server" Text="Promedia vacación" Visible="False" CssClass="checkbox checkbox-primary" />
                    </td>
                    <td style="text-align: left; width: 150px;">
                        <asp:Label ID="lblPeriodo0" runat="server" Text="Periodo Nomina" Visible="False"></asp:Label>
                    </td>
                    <td style="text-align: left; width: 130px;">
                        <asp:DropDownList ID="ddlPeriodo" runat="server" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..." Visible="False" Width="320px">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 20%"></td>
                </tr>
                <tr>
                    <td width="50px" style="width: 20%"></td>
                    <td style="width: 150px; text-align: left">
                    ...
                    <td style="text-align: left" colspan="4">
                        <asp:DropDownList ID="ddlEmpleado" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect"
                            Visible="False" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="ddlEmpleado_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 20%"></td>
                </tr>
                </table>
            <table id="tbDatos" runat="server" visible="false" class="w-100">
                <tr>
                    <td style="width: 20%"></td>
                    <td style="width: 150px; text-align: left">
                        <asp:Label ID="lblECcosto" runat="server" Text="Centro de costo"></asp:Label>
                    </td>
                    <td style="text-align: left; ">
                        <asp:Label ID="lblCodCcosto" runat="server"></asp:Label>
                        <asp:Label ID="lblCentroCosto" runat="server"></asp:Label>
                    </td>
                    <td style="width: 120px; text-align: left">
                        <asp:Label ID="lblEUltimaLiquidacion" runat="server" Text="Ultimas vacaciones"></asp:Label>
                    </td>
                    <td style="text-align: left; width: 250px;">
                        <asp:Label ID="lblUltimaLiquidación" runat="server"></asp:Label>
                    </td>
                    <td style="width: 20%"></td>
                </tr>
                <tr>
                    <td style="width: 20%"></td>
                    <td style="width: 150px; text-align: left">
                        <asp:Label ID="lblESueldo" runat="server" Text="Sueldo"></asp:Label>
                    </td>
                    <td style="text-align: left; ">
                        <asp:Label ID="lblSueldo" runat="server"></asp:Label>
                    </td>
                    <td style="width: 120px; text-align: left">
                        <asp:Label ID="lblEUltimaLiquidacion0" runat="server" Text="Periodo"></asp:Label>
                    </td>
                    <td style="width: 130px; text-align: left;">
                        <asp:Label ID="lblPeriodoIUvacaciones" runat="server"></asp:Label>
                        <asp:Label ID="lblEguion" runat="server" Text="-" Visible="False"></asp:Label>
                        <asp:Label ID="lblPeriodoFUVacaciones" runat="server"></asp:Label>
                    </td>
                    <td style="width: 20%"></td>
                </tr>
                <tr>
                    <td style="width: 20%"></td>
                    <td style="width: 150px; text-align: left">
                        <asp:Label ID="lblEDepartamento" runat="server" Text="Departamento"></asp:Label>
                    </td>
                    <td style="text-align: left; ">
                        <asp:Label ID="lblCodDepartamento" runat="server"></asp:Label>
                        <asp:Label ID="lblDepartamento" runat="server"></asp:Label>
                    </td>
                    <td style="width: 120px; text-align: left">
                        <asp:Label ID="lblEDiasPendientes" runat="server" Text="Dias pendientes"></asp:Label>
                    </td>
                    <td style="width: 130px; text-align: left;">
                        <asp:Label ID="lblDiasPendientes" runat="server"></asp:Label>
                    </td>
                    <td style="width: 20%"></td>
                </tr>
                <tr>
                    <td style="width: 20%"></td>
                    <td style="width: 150px; text-align: left">
                        <asp:Label ID="lblPeriodo" runat="server" Text="Periodo vacaciones"></asp:Label></td>
                    <td style="text-align: left; ">
                        <asp:Label ID="lblPeriodoVacaciones" runat="server"></asp:Label></td>
                    <td style="width: 120px; text-align: left">
                        <asp:Label ID="Label6" runat="server" Text="Tipo vacacion"></asp:Label>
                    </td>
                    <td style="text-align: left; width: 250px;">
                        <asp:DropDownList ID="ddlTipoVacaciones" runat="server" AutoPostBack="True" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect" OnSelectedIndexChanged="ddlTipoVacaciones_SelectedIndexChanged" Width="100%">
                ...
                <tr>
                    <td style="width: 20%"></td>
                    <td style="width: 150px; text-align: left">
                        <asp:Label ID="Label32" runat="server" Text="Periodo"></asp:Label></td>
                    <td style="text-align: left; ">
                        <asp:TextBox ID="txtPeriodoInicial" runat="server" CssClass="input" Font-Bold="True" ToolTip="Formato fecha (dd/mm/yyyy)" Width="150px" AutoPostBack="True" Enabled="False"></asp:TextBox>
                        <asp:TextBox ID="txtPeriodoFinal" runat="server" CssClass="input" Font-Bold="True" ToolTip="Formato fecha (dd/mm/yyyy)" Width="150px" AutoPostBack="True" Enabled="False"></asp:TextBox>
                    </td>
                    <td style="width: 120px; text-align: left">
                        <asp:Label ID="Label34" runat="server" Text="Registro"></asp:Label>
                    </td>
                    <td style="text-align: left; width: 250px;">
                        <asp:TextBox ID="txtCodigo" runat="server" CssClass="input" Font-Bold="True" Width="150px" Enabled="False"></asp:TextBox>
                    </td>
                    <td style="width: 20%"></td>
                </tr>
                <tr>
                    <td style="width: 20%"></td>
                    <td style="width: 150px; text-align: left">
                        <asp:Label ID="lbFecha" runat="server">Fecha salida</asp:Label>
                    </td>
                    <td style="text-align: left; ">
                        <asp:TextBox ID="txtFecha" runat="server" CssClass="input fecha" Font-Bold="True" ToolTip="Formato fecha (dd/mm/yyyy)" Width="150px" AutoPostBack="True" OnTextChanged="txtFecha_TextChanged"></asp:TextBox>
                    </td>
                    <td style="width: 120px; text-align: left">
                        <asp:Label ID="lbDiasCausados" runat="server" Text="Días  causados"></asp:Label>
                    </td>
                    <td style="text-align: left; width: 250px;">
                        <asp:TextBox ID="txvNoDiasCausados" runat="server" AutoPostBack="True" CssClass="input" onkeyup="formato_numero(this)" Width="100px" Enabled="False" OnTextChanged="txvNoDiasCausados_TextChanged">0</asp:TextBox>
                    </td>
                    <td style="width: 20%"></td>
                </tr>
                <tr>
                    <td style="width: 20%"></td>
                    <td style="width: 150px; text-align: left">
                        <asp:Label ID="lbFechaRetorno" runat="server" Text="Fecha retorno"></asp:Label>
                    </td>
                    <td style="text-align: left; ">
                        <asp:TextBox ID="txtFechaRetorno" runat="server" CssClass="input" Font-Bold="True" ToolTip="Formato fecha (dd/mm/yyyy)" Width="150px" AutoPostBack="True" Enabled="False"></asp:TextBox>
                    </td>
                    <td colspan="2" style="text-align: left">
                                    <asp:CheckBox ID="chkPromedioNuevo" runat="server" Text="Nuevo promedio para calcular" AutoPostBack="True" OnCheckedChanged="chkPromedioNuevo_CheckedChanged" />
                                </td>
                    <td style="width: 20%"></td>
                </tr>
                <tr>
                    <td style="width: 20%"></td>
                    <td style="width: 150px; text-align: left">
                        <asp:Label ID="lbDiasTomados" runat="server" Text="Dias tomados"></asp:Label>
                    </td>
                    <td style="text-align: left; ">
                        <asp:TextBox ID="txvNoDiasDisfrutados" runat="server" AutoPostBack="True" CssClass="input" onkeyup="formato_numero(this)" Width="100px">0</asp:TextBox>
                    </td>
                    <td style="width: 120px; text-align: left">
                        <asp:Label ID="lbDiasPagar" runat="server" Text="Dias pagar"></asp:Label>
                    </td>
                    <td style="text-align: left; width: 250px;">
                        <asp:TextBox ID="txvDiasPagar" runat="server" AutoPostBack="True" CssClass="input" onkeyup="formato_numero(this)" Width="100px" Enabled="False">0</asp:TextBox>
                    </td>
                    <td style="width: 20%"></td>
                </tr>
                <tr>
                    <td style="width: 20%"></td>
                    <td style="width: 150px; text-align: left">
                        <asp:Label ID="lbValorBase" runat="server" Text="Valor Base"></asp:Label>
                    </td>
                    <td style="text-align: left; ">
                                    <asp:TextBox ID="txvValorBase" runat="server" CssClass="input" onkeyup="formato_numero(this)" Width="200px" Enabled="False">0</asp:TextBox>
                    </td>
                    <td style="width: 120px; text-align: left">
                        <asp:Label ID="lbDiasPendiente" runat="server" Text="Días pendientes"></asp:Label></td>
                    <td style="text-align: left; width: 250px;">
                        <asp:TextBox ID="txvNoDiasPendientes" runat="server" AutoPostBack="True" CssClass="input" onkeyup="formato_numero(this)" Width="100px">0</asp:TextBox>
                    </td>
                    <td style="width: 20%"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: center" colspan="4">
                        <asp:Button ID="lbPreLiquidar" runat="server" CssClass="botones" OnClick="lbPreLiquidar_Click" OnClientClick="return confirmSwal(this,'Advertencia','¿Esta seguro de preliquidar?');" Text="Pre-liquidar" ToolTip="Guarda el nuevo registro en la base de datos" />
                    </td>
                    <td style="width: 20%"></td>
                </tr>
                <tr>
                            ...
                            <table cellspacing="0" id="datosDet" style="width: 100%">
                                <tr>
                                    ...
                                    <td valign="top" style="width: 700px">
                                        <asp:GridView ID="gvSaludPension" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-sm  table-hover table-striped grillas" GridLines="None" RowHeaderColumn="cuenta" OnRowDeleting="gvSaludPension_RowDeleting" Width="900px">
                                    ...
                                    <td valign="top">
                                        <table class="w-100">
                                            <tr>
                                                ...
                                                <td valign="top">
                                                    <asp:CheckBox ID="chkLiquiNomina" runat="server" AutoPostBack="True" OnCheckedChanged="chkLiquiNomina_CheckedChanged" Text="Paga vacaciones en nómina" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
