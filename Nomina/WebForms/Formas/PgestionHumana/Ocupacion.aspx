<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ocupacion.aspx.cs" Inherits="Nomina.WebForms.Formas.PgestionHumana.Ocupacion" %>
        ...
        <form id="form1" runat="server">
            ...
            <tr>
                ...
                <td style="text-align:left;" colspan="2">
                    <asp:TextBox ID="txtObservacion" placeholder="Observaciones y/o notas..." runat="server" Visible="False" Width="100%" CssClass="input" Height="60px" TextMode="MultiLine"></asp:TextBox></td>
                <td >
                    </td>
            </tr>
            <tr>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemStyle CssClass="Items" HorizontalAlign="Left" />
                             ...
                             <asp:BoundField DataField="notas" HeaderText="Observación" >
                            <ItemStyle CssClass="Items" HorizontalAlign="Left" />
                            </asp:BoundField>
