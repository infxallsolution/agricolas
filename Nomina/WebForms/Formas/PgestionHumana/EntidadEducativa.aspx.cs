...
{
    public partial class EntidadEducativa : BasePage
    {
        #region Instancias

        CentidadEducativa grupo = new CentidadEducativa();
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("nEntidadEducativa", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
        ...
        private void Guardar()
        {
            ...
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("nEntidadEducativa", operacion, "ppa", objValores))
                {
                    case 0:
        ...
        protected void gvLista_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.gvLista.SelectedRow.Cells[4].Text != "")
                    this.txtDireccion.Text = this.gvLista.SelectedRow.Cells[4].Text;
                else
                    this.txtDireccion.Text = "";

                if (this.gvLista.SelectedRow.Cells[5].Text != "")
                    this.txtEmail.Text = this.gvLista.SelectedRow.Cells[5].Text;
                else
                    this.txtEmail.Text = "";

                if (this.gvLista.SelectedRow.Cells[6].Text != "")
                    this.txtTelefono.Text = this.gvLista.SelectedRow.Cells[6].Text;
                else
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (CentidadMetodos.EntidadInsertUpdateDelete("nEntidadEducativa", operacion, "ppa", objValores) == 0)
