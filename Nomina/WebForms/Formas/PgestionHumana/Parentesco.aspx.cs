...
{
    public partial class Parentesco : BasePage
    {
        #region Instancias

        Cparentesco grupo = new Cparentesco();
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("nParentesco", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
        ...
        private void Guardar()
        {
            ...
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("nParentesco", operacion, "ppa", objValores))
                {
                    case 0:
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (CentidadMetodos.EntidadInsertUpdateDelete("nParentesco", operacion, "ppa", objValores) == 0)
