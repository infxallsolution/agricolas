<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EntidadEducativa.aspx.cs" Inherits="Nomina.WebForms.Formas.PgestionHumana.EntidadEducativa" %>
        ...
        <form id="form1" runat="server">
            ...
            <table style="width: 100%" id="tdCampos">
                ...
                <tr>
                    <td ></td>
                    <td style="width:130px; text-align:left;">
                        <asp:Label ID="Label2" runat="server" ForeColor="#404040" Text="Descripción" Visible="False"></asp:Label>
            ...
            <tr>
                <td ></td>
                <td style="width:130px; text-align:left;">
                        <asp:Label ID="Label3" runat="server" ForeColor="#404040" Text="Dirección" Visible="False"></asp:Label>
                ...
                <td ></td>
                    ...
                    <tr>
                        <td ></td>
                        <td style="width:130px; text-align:left;">
                        <asp:Label ID="Label5" runat="server" ForeColor="#404040" Text="E-mail" Visible="False"></asp:Label>
                    ...
                    <tr>
                        <td ></td>
                        <td style="width:130px; text-align:left;">
                        <asp:Label ID="Label4" runat="server" ForeColor="#404040" Text="Teléfono" Visible="False"></asp:Label>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <asp:BoundField DataField="codigo" HeaderText="Código">
                                <ItemStyle Width="50px" CssClass="Items" />
                            </asp:BoundField>
                            <asp:BoundField DataField="descripcion" HeaderText="Descripción">
                               ...
                               <asp:BoundField DataField="email" HeaderText="E-mail">
                                <ItemStyle Width="170px" CssClass="Items" />
                            </asp:BoundField>
