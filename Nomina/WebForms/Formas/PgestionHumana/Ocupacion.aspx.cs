...
{
    public partial class Ocupacion : BasePage
    {
        #region Instancias

        Cocupacion grupo = new Cocupacion();
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("nOcupacion", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
        ...
        private void Guardar()
        {
            ...
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("nOcupacion", operacion, "ppa", objValores))
                {
                    case 0:
        ...
        protected void gvLista_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.gvLista.SelectedRow.Cells[4].Text != "")
                    this.txtObservacion.Text = this.gvLista.SelectedRow.Cells[4].Text;
                else
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (CentidadMetodos.EntidadInsertUpdateDelete("nOcupacion", operacion, "ppa", objValores) == 0)
