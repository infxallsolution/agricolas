...
{
    public partial class Experiencia : BasePage
    {
        #region Instancias



        Cexperiencia expeiencia = new Cexperiencia();
            ...
            try
            {
                using (TransactionScope ts = new TransactionScope())
                {
                    ...
                    object[] objValores = new object[]{
                            ...
                            Convert.ToDecimal(txvTiempo.Text)
                            };

                    switch (CentidadMetodos.EntidadInsertUpdateDelete("nExperienciaLaboral", operacion, "ppa", objValores))
                    {
                        case 0:
        ...
        {
            if (txtCompañia.Text.Length == 0 || txvTiempo.Text.Length == 0 || ddlTercero.SelectedValue.Length == 0 || ddlContratos.SelectedValue.Length == 0)
            {
        ...
        protected void gvLista_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                columna += 1;
                if (dvTercero.Table.Rows[0].ItemArray.GetValue(columna) != null)
                    txtCompañia.Text = dvTercero.Table.Rows[0].ItemArray.GetValue(columna).ToString();
                else
                    txtCompañia.Text = "";
                columna += 1;
                if (dvTercero.Table.Rows[0].ItemArray.GetValue(columna) != null)
                    txtCargo.Text = dvTercero.Table.Rows[0].ItemArray.GetValue(columna).ToString().Trim();
                else
                    txtCargo.Text = "";
                columna += 1;
                if (dvTercero.Table.Rows[0].ItemArray.GetValue(columna) != null)
                    txtJefe.Text = dvTercero.Table.Rows[0].ItemArray.GetValue(columna).ToString();
                else
                    txtJefe.Text = "";
                columna += 1;
                if (dvTercero.Table.Rows[0].ItemArray.GetValue(columna) != null)
                    txvTiempo.Text = dvTercero.Table.Rows[0].ItemArray.GetValue(columna).ToString();
                else
                    txvTiempo.Text = "0";

                columna += 1;
                if (dvTercero.Table.Rows[0].ItemArray.GetValue(columna) != null)
                    txtRetiro.Text = dvTercero.Table.Rows[0].ItemArray.GetValue(columna).ToString();
                else
                    txtRetiro.Text = "";
                columna += 1;
                if (dvTercero.Table.Rows[0].ItemArray.GetValue(columna) != null)
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (CentidadMetodos.EntidadInsertUpdateDelete("nExperienciaLaboral", operacion, "ppa", objValores) == 0)
