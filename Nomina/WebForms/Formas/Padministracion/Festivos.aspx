<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Festivos.aspx.cs" Inherits="Nomina.WebForms.Formas.Padministracion.Festivos" %>
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="width:130px; text-align:left;">
                        <asp:Label ID="lbFecha" runat="server" Visible="False">Fecha Festivo</asp:Label>
                    </td>
                    <td style="text-align: left; width: 400px">
                                                            <asp:TextBox ID="txtFecha" runat="server" CssClass="input fecha" Font-Bold="True" ToolTip="Formato fecha (dd/mm/yyyy)" placeholder="DD/MM/YYYY" Width="100px" AutoPostBack="True" OnTextChanged="txtFechaIngreso_TextChanged" Visible="False"></asp:TextBox>
                    </td>
                    <td ></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:TextBox ID="txvAno" runat="server" Visible="False" Width="100px" onkeypress="formato_numero(this)" CssClass="input"></asp:TextBox>
                    </td>
                    <td ></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        ...
                        <asp:Button ID="btnGenerar" runat="server" CssClass="botones" OnClick="btnGenerar_Click" Text="Generar" ToolTip="Genera festivos todo el año" Visible="False" OnClientClick="return confirmSwal(this,'Advertencia','¿Esta seguro de generar los registros?');" />
                    </td>
                    <td >&nbsp;</td>
                </tr>
            </table>
