<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormaPago.aspx.cs" Inherits="Nomina.WebForms.Formas.Padministracion.FormaPago" %>
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        ...
                        <asp:CheckBox ID="chkCheque" runat="server" Text="Cheque" Visible="False" CssClass="checkbox checkbox-primary" />
                    </td>
                    <td ></td>
                </tr>
                <tr>
