<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrupoConceptos.aspx.cs" Inherits="Nomina.WebForms.Formas.Padministracion.GrupoConceptos" %>
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        ...
                        <asp:TextBox ID="txtCodigo" runat="server" Visible="False" Width="100px" AutoPostBack="True" OnTextChanged="txtConcepto_TextChanged" CssClass="input"></asp:TextBox>
                                </td>
                                <td>
                ...
                <tr>
                    ...
                    <td style="text-align: left;" colspan="2">
                        <asp:TextBox ID="txtObservacion" runat="server" placeholder="Observaciones y/o notas..." Visible="False" Width="100%" CssClass="input" Height="45px" TextMode="MultiLine"></asp:TextBox>
                    </td>
                    <td ></td>
                </tr>
                <tr>
