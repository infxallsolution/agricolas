<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ParametrosNE.aspx.cs" Inherits="Nomina.WebForms.Formas.Padministracion.ParametrosNE" %>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <asp:DropDownList ID="niddlEntitySearch" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect" Width="20%">
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="width: 130px; text-align: left;">
                        <asp:Label ID="Label3" runat="server" ToolTip="Aca podremos seleccionar la entidad Ciudad, Departamento, País, Municipio para generar su equivalencia" Text="Entidad" Visible="False"></asp:Label></td>
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlEntities" runat="server" AutoPostBack="True" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect" OnSelectedIndexChanged="ddlEntities_SelectedIndexChanged"
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td style="width: 130px; text-align: left;">
                        <asp:Label ID="Label4" runat="server" ToolTip="Aca podremos seleccionar el valor de la entidad y posteriormente asociarla al valor que necesita el proveedor de nomina eléctronica" Text="Valor de entidad" Visible="False"></asp:Label></td>
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlEntityValues" runat="server" AutoPostBack="True" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect"
                            Visible="False" Width="100%" OnSelectedIndexChanged="ddlEntityValues_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td></td>
                    <td style="width: 130px; text-align: left;">
                        <asp:Label ID="Label5" runat="server" ToolTip="Aca podremos seleccionar el valor de la entidad y posteriormente asociarla al valor que necesita el proveedor de nomina eléctronica" Text="Equi. aportes en linea" Visible="False"></asp:Label></td>
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlEquivalenceAL" runat="server" AutoPostBack="True" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect"
                            Visible="False" Width="100%">
                        </asp:DropDownList>
                    </td>
                    <td></td>
            ...
            <div class="tablaGrilla">
                <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-sm  table-hover table-striped grillas" OnRowDeleting="gvLista_RowDeleting" Width="100%" OnPageIndexChanging="gvLista_PageIndexChanging" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" PageSize="20" AllowPaging="True">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Equivalence" HeaderText="EquivalenciaAL">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                    </Columns>
