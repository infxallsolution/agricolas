...
{
    public partial class CentroTrabajos : BasePage
    {
        #region Instancias
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("nCentroTrabajo", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
        ...
        private void Guardar()
        {
            ...
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("nCentroTrabajo", operacion, "ppa", objValores))
                {
                    case 0:
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("nCentroTrabajo", "elimina", "ppa", objValores))
                {
                    case 0:
        ...
        protected void lbRegistrar_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToDecimal(txvPorcentaje.Text) > 100)
            {
                MostrarMensaje("El valor de porcentaje no puede ser mayor que 100");
                return;
            }
