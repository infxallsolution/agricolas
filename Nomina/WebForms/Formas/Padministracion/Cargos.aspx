<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cargos.aspx.cs" Inherits="Nomina.WebForms.Formas.Padministracion.Cargos" %>
...
<body style="text-align: center">
    <div class="container">
        ...
        <form id="form1" runat="server">
            ...
            <hr />
            <table style="width: 100%" id="tdCampos">             <tr>
                    <td ></td>
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlCNO" runat="server" Visible="False" Width="100%" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect" ToolTip="Código nacional de ocupación">
                        </asp:DropDownList>
                    </td>
                    <td ></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlJefeInmediato" runat="server" Visible="False" Width="100%" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect">
                        </asp:DropDownList>
                    </td>
                    <td ></td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left; " colspan="2">
                        <asp:TextBox ID="txtObservacion" runat="server" placeholder="Notas y/o observaciones..." Visible="False" Width="100%" CssClass="input" Height="60px" TextMode="MultiLine"></asp:TextBox>
                    </td>
                    <td ></td>
                </tr>
       </table>
