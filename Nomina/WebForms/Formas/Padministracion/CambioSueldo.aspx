<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CambioSueldo.aspx.cs" Inherits="Nomina.WebForms.Formas.Padministracion.CambioSueldo" %>
...
<body style="text-align: center">
    <div class="container">
        ...
        <form id="form1" runat="server">
            <h6>Proceso de Actualización de sueldos</h6>
            <hr />
            <table style="width: 100%" >
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlTipo" runat="server" AutoPostBack="True" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..." Visible="False" Width="100%" OnSelectedIndexChanged="ddlTipo_SelectedIndexChanged">
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        ...
                        <asp:Button ID="btnGuardar" runat="server" CssClass="botones" OnClick="lbPreLiquidar_Click" OnClientClick="return confirmSwal(this,'Advertencia','¿Esta seguro de guardar el registro?');" Text="Guardar" ToolTip="Actualización de sueldos" Visible="False"  />
