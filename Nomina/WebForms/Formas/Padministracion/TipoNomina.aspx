<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoNomina.aspx.cs" Inherits="Nomina.WebForms.Formas.Padministracion.TipoNomina" %>
        ...
        <form id="form1" runat="server">
            ...
            <table style="width: 100%" id="tdCampos">
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlPeriocidad" runat="server" Width="100%" data-placeholder="Seleccione una opción..."  CssClass="chzn-select-deselect" Visible="False">
