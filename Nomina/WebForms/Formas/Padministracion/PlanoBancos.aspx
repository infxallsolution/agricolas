<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanoBancos.aspx.cs" Inherits="Nomina.WebForms.Formas.Padministracion.PlanoBancos" %>
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlBanco" runat="server" Visible="False" Width="350px" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect" ToolTip="Código nacional de ocupación" AutoPostBack="True" OnSelectedIndexChanged="ddlBanco_SelectedIndexChanged">
                        </asp:DropDownList>
                ...
                <tr>
                    <td></td>
                    <td style="width: 130px; text-align: left;">
                        <asp:Label ID="Label8" runat="server" Text="Tipo de linea" Visible="False"></asp:Label></td>
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlTipoRegistro" runat="server" Visible="False" Width="150px" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect">
                            <asp:ListItem Value="1">Cabeza</asp:ListItem>
                            <asp:ListItem Value="0">Detalle</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlCampos" runat="server" Visible="False" Width="350px" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect" ToolTip="Código nacional de ocupación">
                        </asp:DropDownList>
                    </td>
                    <td></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlTipoDatos" runat="server" Visible="False" Width="150px" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect">
                ...
                <tr>
                    ...
                    <td></td>
                                ...
                                <asp:GridView ID="gvListaDetalle" runat="server" Width="100%" AutoGenerateColumns="False" OnRowDeleting="gvListaDetalle_RowDeleting" GridLines="None" RowHeaderColumn="cuenta" CssClass="table table-bordered table-sm  table-hover table-striped grillas" AllowSorting="True" OnSelectedIndexChanged="gvListaDetalle_SelectedIndexChanged">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="tipoRegistro" HeaderText="TR">
                                            <HeaderStyle />
                                            <ItemStyle Width="10px" />
                                        </asp:BoundField>
                                    </Columns>
