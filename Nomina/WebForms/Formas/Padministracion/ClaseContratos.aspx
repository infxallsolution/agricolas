<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaseContratos.aspx.cs" Inherits="Nomina.WebForms.Formas.Padministracion.ClaseContratos" %>
    ...
    <div class="container">
        ...
        <form id="form1" runat="server">
            ...
            <table style="width: 100%" id="tdCampos">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: left; width: 130px" colspan="2">
                        <asp:CheckBox ID="chkTerminoFijo" runat="server" Text="Termino fijo" Visible="False" CssClass="checkbox checkbox-primary" />
                        <asp:CheckBox ID="chkActivo" runat="server" Text="Activo" Visible="False" CssClass="checkbox checkbox-primary" />
                        <asp:CheckBox ID="chkElectivaProduccion" runat="server" Text="Etapa electiva o producción" Visible="False" AutoPostBack="True" OnCheckedChanged="chkElectivaProduccion_CheckedChanged" CssClass="checkbox checkbox-primary" />
                    </td>
                    <td></td>
                </tr>
                <tr>
