<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiasHabiles.aspx.cs" Inherits="Nomina.WebForms.Formas.Padministracion.DiasHabiles" %>
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlCcosto" runat="server" AutoPostBack="True" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect"
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlDe" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect"
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlHasta" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect"
                            Visible="False" Width="100px">
                            <asp:ListItem Value="1">Lunes</asp:ListItem>
                            <asp:ListItem Value="2">Martes</asp:ListItem>
                            <asp:ListItem Value="3">Miercoes</asp:ListItem>
