<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstructuraCCosto.aspx.cs" Inherits="Nomina.WebForms.Formas.Padministracion.EstructuraCCosto" %>
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="width: 400px; text-align: left;">
                        <asp:Label ID="Label1" runat="server" Text="Nivel" Visible="False"></asp:Label></td>
                    <td style="text-align: left; width: 400px">
                        <asp:TextBox ID="txtCodigo" runat="server" Visible="False" Width="100px" AutoPostBack="True" CssClass="input"></asp:TextBox>
                ...
                <tr>
                    <td></td>
                    <td style="width: 400px; text-align: left;">
                        <asp:Label ID="Label3" runat="server" Text="Inicio" Visible="False"></asp:Label></td>
                    <td style="text-align: left; width: 400px">
                ...
                <tr>
                    <td></td>
                    <td style="width: 400px; text-align: left;">
                        <asp:Label ID="Label4" runat="server" Text="Tamaño" Visible="False"></asp:Label></td>
                    <td style="text-align: left; width: 400px">
                ...
                <tr>
                    <td></td>
                    <td style="width: 400px; text-align: left;">
                        <asp:Label ID="Label5" runat="server" Text="Total" Visible="False"></asp:Label></td>
                    <td style="text-align: left; width: 400px">
