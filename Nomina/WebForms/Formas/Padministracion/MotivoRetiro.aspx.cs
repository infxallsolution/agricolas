...
{
    public partial class MotivoRetiro : BasePage
    {
        #region Instancias
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("nMotivoRetiro", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("nMotivoRetiro", "elimina", "ppa", objValores))
                {
                    case 0:
