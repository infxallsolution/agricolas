...
{
    public partial class ClaseContratos : BasePage
    {
        #region Instancias
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("nClaseContrato", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("nClaseContrato", "elimina", "ppa", objValores))
                {
                    case 0:
        ...
        protected void lbRegistrar_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToDecimal(txvPorcentajeSS.Text) > 100 || Convert.ToDecimal(txvProcentajePago.Text) > 100)
            {
