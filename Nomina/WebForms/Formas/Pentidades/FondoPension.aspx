<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FondoPension.aspx.cs" Inherits="Nomina.WebForms.Formas.Pentidades.FondoPension" %>
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:TextBox ID="txtCodigo" runat="server" Visible="False" Width="180px" AutoPostBack="True" OnTextChanged="txtConcepto_TextChanged" CssClass="input"></asp:TextBox>
