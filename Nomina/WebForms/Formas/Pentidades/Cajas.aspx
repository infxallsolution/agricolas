<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cajas.aspx.cs" Inherits="Nomina.WebForms.Formas.Pentidades.Cajas" %>
        ...
        <form id="form1" runat="server">
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        ...
                        <asp:CheckBox ID="chkActivo" runat="server" Text="Activo" Visible="False" CssClass="checkbox checkbox-primary" />
                         <asp:CheckBox ID="chkIntegral" runat="server" Text="Integral" Visible="False" CssClass="checkbox checkbox-primary" />
                    </td>
                    <td ></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlPais" runat="server" Visible="False" Width="100%" data-placeholder="Seleccione una opción..."  CssClass="chzn-select-deselect" AutoPostBack="True" OnSelectedIndexChanged="ddlPais_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td ></td>
                </tr>
