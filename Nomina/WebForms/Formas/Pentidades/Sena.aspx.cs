...
{
    public partial class Sena : BasePage
    {
        #region Instancias
        ...
        private void cargarCiudad()
        {
            try
            {
                DataView ciudad = CcontrolesUsuario.OrdenarEntidad(CentidadMetodos.EntidadGet("gCiudad", "ppa"), "descripcion", Convert.ToInt16(this.Session["empresa"])); ;
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("nEntidadSena", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
            ...
            else
            {
                try
                {
                   ...
                   Convert.ToString(Session["usuario"])
                    ...
                    switch (CentidadMetodos.EntidadInsertUpdateDelete("nEntidadSena", operacion, "ppa", objValores))
                    {
                        case 0:
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("nEntidadSena", "elimina", "ppa", objValores))
                {
                    case 0:
        ...
        protected void lbRegistrar_Click(object sender, EventArgs e)
        {
            ...
            {
                MostrarMensaje("Campos porcentaje del empleado no puede ser mayor a 100, por avor corrija");
                return;
            }
