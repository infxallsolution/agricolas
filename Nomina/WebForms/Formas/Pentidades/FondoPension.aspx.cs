...
{
    public partial class FondoPension : BasePage
    {
        #region Instancias
        ...
        protected void lbRegistrar_Click(object sender, EventArgs e)
        {
            ...
            {
                MostrarMensaje("Campos porcentaje del empleador no puede ser mayor a 100, por avor corrija");
                return;
            }

            if (Convert.ToDecimal(txvPinactividad.Text) > 100)
            {
                MostrarMensaje("Campos porcentaje del inactividad no puede ser mayor a 100, por avor corrija");
                return;
            }
