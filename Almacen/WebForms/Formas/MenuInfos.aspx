<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuInfos.aspx.cs" Inherits="Almacen.WebForms.Formas.MenuInfos" %>
    ...
    <form id="form1" runat="server" style="margin: 0; padding: 0; width: 100%;">
                ...
                <ul id="nav">
                    <li class="" style="text-align: left"><a class="" href="#">Administración</a>
                        <ul class="submenu">
                            ...
                            <li><a href="#">Items</a>
                                <ul class="subsubmenu">
                                    <li><a href="#" onclick="addTab('Tipo inv.','Padministracion/TipoServicios.aspx',true)">Tipo de inventario</a></li>
                                    <li><a href="#" onclick="addTab('Grupo Item.','Padministracion/Planes.aspx',true)">Grupos de item</a></li>
                                    <li><a href="#" onclick="addTab('Subgrupo Item','Padministracion/Mayores.aspx',true)">Subgrupo de item</a></li>
                                    <li><a href="#" onclick="addTab('Items.','Padministracion/Items.aspx',true)">Registro...</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li class="" style="text-align: left"><a class="" href="#">Almacén</a>
                        <ul class="submenu">
                            <li><a href="#" onclick="addTab('Requerimientos','pTransaccion/Requerimiento.aspx',true)">Requerimientos </a></li>
                            <li><a href="#">Entradas</a>
                                <ul class="subsubmenu">
                                    <li><a href="#" onclick="addTab('Entradas Direct','pTransaccion/EntradasDirectas.aspx',true)">Directas...</a></li>
                                    <li><a href="#" onclick="addTab('Entradas Alm','pTransaccion/Entradas.aspx',true)">Por referencia</a></li>
                                </ul>
                            </li>
                            <li><a href="#">Salidas</a>
                                <ul class="subsubmenu">
                                    <li><a href="#" onclick="addTab('Salidas Direc','pTransaccion/SalidasDirectas.aspx',true)">Directas...</a></li>
                                    <li><a href="#" onclick="addTab('Salidas Reque','pTransaccion/Salidas.aspx',true)">Por requerimiento</a></li>
                                </ul>
                            </li>
                            <li><a href="#">Devoluciones</a>
                                <ul class="subsubmenu">
                                    <li><a href="#" onclick="addTab('Devolución Alm','pTransaccion/EntradaSalida.aspx',true)">Al almacén...</a></li>
                                    <li><a href="#" onclick="addTab('Devolución Prov','pTransaccion/SalidaEntrada.aspx',true)">Al proveedor...</a></li>
                                </ul>
                            </li>
                            <li><a href="#" onclick="addTab('Traslados','pTransaccion/Traslados.aspx',true)">Traslados</a></li>
                        </ul>
                    </li>
                    <li class="" style="text-align: left"><a class="" href="#">Inventario</a>
                        <ul class="submenu">
                            <li><a href="#" onclick="addTab('Conteo','pTransaccion/Inventario.aspx',true)">Conteo fisico </a></li>
                        </ul>
                    </li>
        ...
        <div id="footer">
            <div class="row text-left  p-2">
                ...
                <div class="col-1">
                    <a id="iconoModulo" runat="server"></a>
                </div>
            </div>
