<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Planes.aspx.cs" Inherits="Almacen.WebForms.Formas.Padministracion.Planes" %>
        ...
        <form id="form1" runat="server">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-1 checkbox checkbox-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <asp:TextBox ID="txtDescripcion" runat="server" CssClass="input" MaxLength="550" Visible="False" Width="100%"></asp:TextBox>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <asp:TextBox ID="txtObservacion" runat="server" CssClass="input" MaxLength="550" Visible="False" Width="100%" Height="36px" TextMode="MultiLine"></asp:TextBox>
                    </div>
                     <div class="col-2">
