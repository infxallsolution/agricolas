<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Destinos.aspx.cs" Inherits="Almacen.WebForms.Formas.Padministracion.Destinos" %>
        ...
        <form id="form1" runat="server">
            ...
            <table style="width: 100%" id="tdCampos">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: left; width: 130px">
                        <asp:Label ID="Label8" runat="server" Text="Afecta a?" Visible="False"></asp:Label>
                    </td>
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlAfecta" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect" Visible="False" Width="100%">
                            <asp:ListItem Value="C">Compra</asp:ListItem>
                            <asp:ListItem Value="V">Venta</asp:ListItem>
                            <asp:ListItem Value="G">Gasto</asp:ListItem>
                            <asp:ListItem Value="S">Costo</asp:ListItem>
                            <asp:ListItem Value="I">Iversión</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td></td>
                </tr>
            ...
            <div class="tablaGrilla">
                ...
                <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-sm  table-hover table-striped grillas" OnRowDeleting="gvLista_RowDeleting" Width="100%" OnPageIndexChanging="gvLista_PageIndexChanging" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" PageSize="20" AllowPaging="True">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="afecta" HeaderText="Afecta?">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left"  Width="50px" />
                        </asp:BoundField>
