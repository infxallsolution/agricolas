<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Entradas.aspx.cs" Inherits="Almacen.WebForms.Formas.Ptransaccion.Entradas" %>
                            ...
                            <asp:UpdatePanel ID="upRegistro" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                            ...
                                            <table class="w-100">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3" style="text-align: left">
                                                        <asp:DropDownList ID="ddlSucursal" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect" Visible="False" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="ddlSucursal_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="2" style="text-align: left">
                                                        <asp:DropDownList ID="ddlOC" runat="server" AutoPostBack="True" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..." OnSelectedIndexChanged="ddlOC_SelectedIndexChanged" Visible="False" Width="95%">
                                                        </asp:DropDownList>
                                                    </td>

                                                    <td>
                                                        <asp:Label ID="lblFechaReferecia" runat="server" Text="" Visible="False"></asp:Label>
                                                        <asp:TextBox ID="txtFechaReferencia" runat="server" CssClass="input" Visible="False" Width="50%"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <asp:UpdatePanel ID="upDetalle" runat="server" UpdateMode="Conditional" Visible="False">
                                        <ContentTemplate>
                                            <hr>
                                            <asp:GridView ID="gvReferencia" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-sm  table-hover table-striped grillas" Width="100%">
                                                <AlternatingRowStyle CssClass="alt" />
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:HiddenField ID="hfRegistro" runat="server" Value='<%# Eval("registro") %>' />
                                                            <asp:HiddenField ID="hfProducto" runat="server" Value='<%# Eval("idItem") %>' />
                                                            <asp:HiddenField ID="hfOc" runat="server" Value='<%# Eval("oc") %>' />
                                                            <asp:HiddenField ID="hfCantidadOC" runat="server" Value='<%#Eval("saldo") %>' />
                                                            <asp:CheckBox ID="chkSeleccion" runat="server" Checked='<%# Eval("check") %>' AutoPostBack="True" OnCheckedChanged="chkSeleccion_CheckedChanged" />
                                                        </ItemTemplate>
                                                        <HeaderStyle BackColor="White" BorderColor="White" BorderStyle="None" />
                                                        <ItemStyle BorderColor="Silver" BorderStyle="Dotted" BorderWidth="1px" Width="2%" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Bodega">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:DropDownList ID="ddlBodega" Width="100%" data-placeholder="Seleccione una opción..." runat="server" CssClass="chzn-select-deselect" AutoPostBack="True" OnSelectedIndexChanged="ddlBodega_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ItemTemplate>
                                                        <ItemStyle Width="30%" />
                                                    </asp:TemplateField>
                                                    <asp:BoundField DataField="cantidad" DataFormatString="{0:N2}" HeaderText="Cant O.C.">
                                                        <ItemStyle HorizontalAlign="Right" />
                                                        <ItemStyle Width="8%" />
                                                    </asp:BoundField>
                                                    <asp:TemplateField HeaderText="Cantidad">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtCantidad" runat="server" CssClass="input" onkeyup="formato_numero(this)" Text='<%# Eval("saldo") %>' Width="60px" AutoPostBack="True" OnTextChanged="txtCantidad_TextChanged"></asp:TextBox>
                                                        </ItemTemplate>
                                                        <HeaderStyle BorderColor="Silver" BorderStyle="Dotted" BorderWidth="1px" HorizontalAlign="Right" />
                                                        <ItemStyle BorderColor="Silver" BorderStyle="Dotted" BorderWidth="1px" HorizontalAlign="Right" Width="50px" />
                                                    </asp:TemplateField>
                                                    <asp:BoundField DataField="valorUnitario" DataFormatString="{0:N2}" HeaderText="VlUnitarioO.C.">
                                                        <ItemStyle HorizontalAlign="Right" />
                                                        <ItemStyle Width="8%" />
                                                    </asp:BoundField>
                                                    <asp:TemplateField HeaderText="Vlr. Unitario">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtValorUnitario" runat="server" CssClass="input" onkeyup="formato_numero(this)" Text='<%# Eval("valorUnitario","{0:N2}") %>' Width="100%" AutoPostBack="True" OnTextChanged="txtValorUnitario_TextChanged"></asp:TextBox>
                                                        </ItemTemplate>
                                                        <HeaderStyle BorderColor="Silver" BorderStyle="Dotted" BorderWidth="1px" HorizontalAlign="Right" />
                                                        <ItemStyle BorderColor="Silver" BorderStyle="Dotted" BorderWidth="1px" HorizontalAlign="Right" Width="8%" />
                                                    </asp:TemplateField>
