<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalidaEntrada.aspx.cs" Inherits="Almacen.WebForms.Formas.Ptransaccion.SalidaEntrada" %>
                                    ...
                                    <asp:UpdatePanel ID="upCabeza" runat="server" UpdateMode="Conditional" Visible="False">
                                        <ContentTemplate>
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td style="vertical-align: top; width: 125px; text-align: left">
                                                        <asp:Label ID="lblFecha" runat="server" Visible="False" Style="color: #003366">Fecha</asp:Label></td>
                                                    <td style="text-align: left">
                                                        <asp:TextBox ID="txtFecha" runat="server" Font-Bold="True" ForeColor="Gray" ReadOnly="True" Visible="False" CssClass="input fecha" AutoPostBack="True" OnTextChanged="txtFecha_TextChanged"></asp:TextBox>
                                                    </td>
                                                    <td style="text-align: left; width: 180px">
                                                        <asp:Label ID="lblDocref" runat="server" Text="Docto referencia" Visible="False"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtDocref" runat="server" CssClass="input" Visible="False"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td style="width: 125px; text-align: left">
                                                        <asp:Label ID="lblSalida" runat="server" Text="Entrada" Visible="False"></asp:Label>
                                                    </td>
                                                    <td class="auto-style4" colspan="3" style="text-align: left">
                                                        <asp:DropDownList ID="ddlSalida" runat="server" AutoPostBack="True" data-placeholder="Seleccione una entrada..." CssClass="chzn-select-deselect" OnSelectedIndexChanged="ddlSalida_SelectedIndexChanged" Visible="False" Width="80%">
                                                        </asp:DropDownList>
                                                        <asp:TextBox ID="txtFechaReferencia" runat="server" Visible="False" Width="100px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 125px; text-align: left">
                                                    ...
                                                    <td style="text-align: left" colspan="3">
                                                        <asp:DropDownList ID="ddlTercero" runat="server" Visible="False" Width="70%" CssClass="chzn-select-deselect" AutoPostBack="True" OnSelectedIndexChanged="ddlTercero_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                        <asp:DropDownList ID="ddlSucursal" runat="server" AutoPostBack="True" CssClass="chzn-select-deselect" OnSelectedIndexChanged="ddlSucursal_SelectedIndexChanged" Visible="False" Width="25%">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="auto-style4" colspan="3" style="text-align: left">
                                                        <asp:DropDownList ID="ddlSolicitante" data-placeholder="Seleccione una opción..." runat="server" CssClass="chzn-select-deselect" Visible="False" Width="95%">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-sm  table-hover table-striped grillas" GridLines="None" Width="100%" OnRowDataBound="gvLista_RowDataBound">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Cantidad">
                                                            <ItemTemplate>
                                                                <asp:HiddenField ID="hfRegistro" Value='<%#Eval("registro") %>' runat="server" />
                                                                <asp:TextBox ID="txvCantidadDetalle" OnTextChanged="txvCantidadDetalle_TextChanged" AutoPostBack="true" runat="server" CssClass="input" onkeyup="formato_numero(this)" Text='<%#Eval("cantidad") %>' Width="100%" Wrap="False"></asp:TextBox>
                                                            </ItemTemplate>
                                                            <ItemStyle Width="8%" />
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="saldo" DataFormatString="{0:N2}" HeaderText="Cantidad EA">
                                                            <ItemStyle Width="8%" />
                                                        </asp:BoundField>
