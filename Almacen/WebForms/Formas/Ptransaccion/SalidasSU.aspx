<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalidasSU.aspx.cs" Inherits="Almacen.WebForms.Formas.Ptransaccion.SalidasSU" %>
                                                            ...
                                                            <div style="display: inline-block">
                                                                <table style="width: 1000px;">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="auto-style4" colspan="3" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlSolicitante" runat="server" AutoPostBack="True" CssClass="chosen-select-deselect input-group" data-placeholder="Seleccione una opción..." OnSelectedIndexChanged="ddlOC_SelectedIndexChanged" Visible="False" Width="700px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td style="text-align: left; vertical-align: top; width: 160px;">
                                                                                <table cellpadding="0" style="padding: 0px">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="width: 100%; text-align: left">
                                                                                            <asp:DropDownList ID="ddlBodega" data-placeholder="Seleccione una opción..." AutoPostBack="true" runat="server" CssClass="chosen-select-deselect input-group" Visible="False" Width="200px" OnSelectedIndexChanged="ddlBodega_SelectedIndexChanged">
                                                                                            </asp:DropDownList>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="width: 100%; text-align: left">
                                                                                            <asp:Label ID="lblUmedidaSaldo" runat="server" Text="Und Medida en existencia" Visible="False"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="width: 100%; text-align: left">
                                                                                            <asp:DropDownList ID="ddlUmedidaSaldo" runat="server" CssClass="chosen-select-deselect input-group" Visible="False" Width="200px">
                                                                                            </asp:DropDownList>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                            ...
                                                                            <td style="text-align: left; vertical-align: top;">
                                                                                <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-sm  table-hover table-striped grillas" OnRowDeleting="gvLista_RowDeleting" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" Width="100%">
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:BoundField DataField="bodega" HeaderText="Bodega"></asp:BoundField>
                                                ...
                                                <table style="width: 1000px; padding: 0; border-collapse: collapse;">
                                                    <tr>
                                                        <td style="width: 1000px; text-align: left;">
                                                            <asp:GridView ID="gvTransaccion" runat="server" Width="100%" AutoGenerateColumns="False" GridLines="None" OnRowCommand="gvTransaccion_OnRowCommand" OnRowDeleting="gvTransaccion_RowDeleting" OnRowUpdating="gvTransaccion_RowUpdating" CssClass="table table-bordered table-sm  table-hover table-striped grillas" Visible="False">
                                                                <AlternatingRowStyle CssClass="alt" />
                                                                <Columns>
