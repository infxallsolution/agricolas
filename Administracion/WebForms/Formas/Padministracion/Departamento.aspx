<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Departamento.aspx.cs" Inherits="Administracion.WebForms.Formas.Padministracion.Departamento" %>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td style="text-align: left">
                        <asp:DropDownList ID="niddlPais" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlEntidad_SelectedIndexChanged" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect"
                            Width="100%">
                        </asp:DropDownList>
                    </td>
                </tr>
