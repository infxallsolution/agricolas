<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Campos.aspx.cs" Inherits="Administracion.WebForms.Formas.Padministracion.Campos" %>
    ...
    <div class="container">
        ...
        <form id="form1" runat="server">
            ...
            <table id="tdCampos"  width="100%">
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:DropDownList ID="ddlEntidad" runat="server"  Width="100%" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect" Visible="False">
                        </asp:DropDownList>
                    </td>
                    <td></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:TextBox ID="txtCampo" runat="server" CssClass="input" Width="100%" Visible="False"></asp:TextBox>
                    </td>
                    <td></td>
                </tr>
                </table>
            ...
            <div class="tablaGrilla">
                ...
                <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-sm  table-hover table-striped grillas" OnRowDeleting="gvLista_RowDeleting" Width="100%" OnPageIndexChanging="gvLista_PageIndexChanging" PageSize="40" AllowPaging="True">
