<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Auxiliares.aspx.cs" Inherits="Administracion.WebForms.Formas.Padministracion.Auxiliares" %>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td style="text-align: left">
                        <asp:DropDownList ID="niddlEntidad" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlEntidad_SelectedIndexChanged" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect"
                            Width="100%">
                        </asp:DropDownList>
                    </td>
                </tr>
