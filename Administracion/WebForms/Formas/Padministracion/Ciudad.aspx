<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ciudad.aspx.cs" Inherits="Administracion.WebForms.Formas.Padministracion.Ciudad" %>
        ...
        <form id="form1" runat="server">
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td style="text-align: left">
                        <asp:DropDownList ID="niddlDeparamento" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlEntidad_SelectedIndexChanged" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect"
                            Width="100%">
                        </asp:DropDownList>
                    </td>
                </tr>
            ...
            <table  width="100%">
                <tr>
                    <td></td>
                    <td class="text-left">
                        <asp:Label ID="Label3" runat="server" Text="Pais" CssClass="label" Visible="false"></asp:Label>
                    </td>
                    <td class="text-left">
                        <asp:DropDownList ID="ddlPais" runat="server" data-placeholder="Seleccione una pais..." CssClass="chzn-select-deselect" Visible="false"
                            Width="100%">
                        </asp:DropDownList>
                    </td>
                </tr>
                ...
                <tr>
                    <td></td>
                    <td class="text-left">
                        <asp:Label ID="Label2" runat="server" Text="Descripción"  CssClass="label" Visible="False"></asp:Label></td>
                    <td class="text-left">
