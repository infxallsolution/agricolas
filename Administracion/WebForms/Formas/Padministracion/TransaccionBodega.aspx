<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransaccionBodega.aspx.cs" Inherits="Administracion.WebForms.Formas.Padministracion.TransaccionBodega" %>
        ...
        <form id="form1" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-8 text-center">
                    <select runat="server" id="selBodega" class="multiselect" multiple="true" name="countries[]"  style="width: 700px; height: 200px;" visible="False">
                    </select>
                </div>
            </div>
            <hr />
