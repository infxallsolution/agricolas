...
{
    public partial class Auxiliares : BasePage
    {
        #region Instancias
        ...
        private void GetEntidad()
        {
            try
            {
                ...
                if (Convert.ToString(this.niddlEntidad.SelectedValue.Trim()).Length == 0)
                {
                    ManejoError("Debe seleccionar una entidad para realizar la busqueda", "I");
                ...
                {
                    this.gvLista.DataSource = entidades.BuscarEntidad(this.nitxtBusqueda.Text, Convert.ToString(this.niddlEntidad.SelectedValue),
        ...
        private void CargarCombos()
        {
            try
            {
                ...
                this.niddlEntidad.Items.Insert(0, new System.Web.UI.WebControls.ListItem("", ""));
            }
            catch (Exception ex)
            {
                ManejoErrorCatch(ex);
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                ...
                if (CentidadMetodos.EntidadGetKey(Convert.ToString(this.niddlEntidad.SelectedValue), "ppa", objKey).Tables[0].Rows.Count > 0)
                {

                    ManejoError(Convert.ToString(this.niddlEntidad.SelectedValue) + " " + this.txtCodigo.Text + " ya se encuentra registrado", "I");
        ...
        private void Guardar()
        {
            ...
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete(Convert.ToString(this.niddlEntidad.SelectedValue), operacion, "ppa", objValores))
                {
                    case 0:
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (CentidadMetodos.EntidadInsertUpdateDelete(Convert.ToString(this.niddlEntidad.SelectedValue), operacion, "ppa", objValores) == 0)
