...
{
    public partial class Departamento : BasePage
    {
        #region Instancias
        ...
        private void GetEntidad()
        {
            try
            {
                ...
                if (Convert.ToString(this.niddlPais.SelectedValue.Trim()).Length == 0)
                {
                ...
                {
                    this.gvLista.DataSource = departamento.BuscarEntidad(this.nitxtBusqueda.Text, Convert.ToString(this.niddlPais.SelectedValue),
        ...
        private void CargarCombos()
        {
            try
            {
                this.niddlPais.DataSource = CcontrolesUsuario.OrdenarEntidadSinEmpresa(CentidadMetodos.EntidadGet("gPais", "ppa"), "descripcion");
                this.niddlPais.DataValueField = "codigo";
                this.niddlPais.DataTextField = "descripcion";
                this.niddlPais.DataBind();
                this.niddlPais.Items.Insert(0, new System.Web.UI.WebControls.ListItem("", ""));
            }
            catch (Exception ex)
            {
                ManejoErrorCatch(ex);
        ...
        {
            object[] objKey = new object[] { this.txtCodigo.Text, Convert.ToInt16(Session["empresa"]), niddlPais.SelectedValue };
            ...
            try
            {
                ...
                if (CentidadMetodos.EntidadGetKey("gDepartamento", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
                    ManejoError(Convert.ToString(this.niddlPais.SelectedValue) + " " + this.txtCodigo.Text + " ya se encuentra registrado", "I");
        ...
        private void Guardar()
        {
            ...
            try
            {
                ...
                niddlPais.SelectedValue
            };

                switch (CentidadMetodos.EntidadInsertUpdateDelete("gDepartamento", operacion, "ppa", objValores))
                {
                    case 0:
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                object[] objValores = new object[] { Convert.ToString(this.gvLista.Rows[e.RowIndex].Cells[2].Text), Convert.ToInt16(this.Session["empresa"]), niddlPais.SelectedValue };

                if (CentidadMetodos.EntidadInsertUpdateDelete("gDepartamento", operacion, "ppa", objValores) == 0)
