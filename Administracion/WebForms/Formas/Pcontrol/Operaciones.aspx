<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Operaciones.aspx.cs" Inherits="Administracion.WebForms.Formas.Pcontrol.Operaciones" %>
...
<body style="text-align: center">
    <div class="container">
        ...
        <form id="form1" runat="server">
            ...
            <hr />
            <table id="tdCampos" class="text-left"  width="100%">
                <tr>
                    <td></td>
                    <td width="250px" >
