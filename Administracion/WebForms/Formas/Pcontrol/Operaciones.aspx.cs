...
{
    public partial class Operaciones : BasePage
    {
        ...
        private void GetEntidad()
        {
            try
            {
                ...
                this.gvLista.DataSource = operaciones.BuscarEntidad(this.nitxtBusqueda.Text);
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("sOperaciones", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
        ...
        private void Guardar()
        {
            ...
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("sOperaciones", operacion, "ppa", objValores))
                {
                    case 0:
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (CentidadMetodos.EntidadInsertUpdateDelete("sOperaciones", operacion, "ppa", objValores) == 0)
