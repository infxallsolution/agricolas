...
{
    public partial class Vehiculos : BasePage
    {
        #region Instancias
        ...
        private void CargarCombos()
        {
            try
            {
                this.ddlTipoVehiculo.DataSource = CcontrolesUsuario.OrdenarEntidadSinEmpresayActivo(CentidadMetodos.EntidadGet("bTipoVehiculo", "ppa"), "descripcion");
        ...
        {
            object[] objKey = new object[] { this.txtCodigo.Text, ddlTipoVehiculo.SelectedValue };
            try
            {
                if (CentidadMetodos.EntidadGetKey("bVehiculo", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
                    this.nilblInformacion.Visible = true;
                    ManejoError("Código " + this.txtCodigo.Text + " ya se encuentra registrado", "I");
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                object[] objValores = new object[] { Convert.ToString(this.gvLista.Rows[e.RowIndex].Cells[2].Text), Convert.ToString(this.gvLista.Rows[e.RowIndex].Cells[5].Text) };
