<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoVehiculo.aspx.cs" Inherits="Administracion.WebForms.Formas.Poperaciones.TipoVehiculo" %>
        ...
        <form id="form1" runat="server">
            ...
            <table id="tdCampos" width="100%">
                ...
                <tr>
                    ...
                    <td class="text-left">
                        <asp:CheckBox CssClass="checkbox checkbox-primary" ID="chkManejaRemolque" runat="server" Text="Maneja Remolque" Visible="False" />
                    </td>
                    <td></td>
                </tr>
                </table>
