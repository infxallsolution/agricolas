<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuInfos.aspx.cs" Inherits="Administracion.WebForms.Formas.MenuInfos" %>
            ...
            <div class="col-10">
                <ul id="nav">
                        ...
                        <ul class="submenu">
                            <li class="" style="text-align: left"><a class="" href="#">Parametros</a>
                                <ul class="subsubmenu">
                                    ...
                                    <li><a href="#" onclick="addTab('Parametros General','Padministracion/ParametrosGeneralConfig.aspx',true)">Parametros Generales </a></li>
                                    <li><a href="#" onclick="addTab('Entidades Auxiliares','Padministracion/Auxiliares.aspx',true)">Entidades auxiliares</a></li>
                                    <li><a href="#" onclick="addTab('Departamentos','Padministracion/Departamento.aspx',true)">Departamentos</a></li>
                                    <li><a href="#" onclick="addTab('Ciudades','Padministracion/Ciudad.aspx',true)">Ciudades</a></li>
                                    <li><a href="#" onclick="addTab('Tipo Documento','Padministracion/TipoDocumento.aspx',true)">Tipos Documentos</a></li>
                                    <li><a href="#" onclick="addTab('Campos','Padministracion/Campos.aspx',true)">Campos</a></li>
                                </ul>
                            </li>

                            <li class="" style="text-align: left"><a class="" href="#">Tipo de Transacción</a>
                                <ul class="subsubmenu">
                                    <li><a href="#" onclick="addTab('Tipos Transacción','Padministracion/TransaccionTipos.aspx',true)">Registro...</a></li>
                                    <li><a href="#" onclick="addTab('TransCampos','Padministracion/TransaccionCampos.aspx',true)">Campos...</a></li>
                                    <li><a href="#" onclick="addTab('TransConfig','Padministracion/TransaccionConfig.aspx',true)">Configuración...</a></li>
                                    <li><a href="#" onclick="addTab('Trn Bodega','Padministracion/TransaccionBodega.aspx',true)">Relacionar Bodega</a></li>
                                    <li><a href="#" onclick="addTab('Trn Producto','Padministracion/TransaccionProducto.aspx',true)">Relacionar Producto</a></li>
                                </ul>
                            </li>
                    ...
                    <li class="" style="text-align: left"><a class="" href="#">Seguridad</a>
                        <ul class="submenu">
                            <li class="" style="text-align: left"><a class="" href="#">Parametros de seguridad</a>
                                <ul class="subsubmenu">
                                    ...
                                    <li><a href="#" onclick="addTab('Menu','Pcontrol/Menu.aspx',true)">Menu</a></li>
                                    <li><a href="#" onclick="addTab('Log','Pcontrol/ConsultarLog.aspx',true)">Consultar Log</a></li>
                                </ul>
                            </li>
                            <li class="" style="text-align: left"><a class="" href="#">Parametros de usuario</a>
                                <ul class="subsubmenu">
                                    ...
                                    <li><a href="#" onclick="addTab('Permisos','Pcontrol/Permisos.aspx',true)">Permisos</a></li>
                                    <li><a href="#" onclick="addTab('Huella','Padministracion/RegistrarHuella.aspx',true)">Registro de huella digital</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="" style="text-align: left"><a class="" href="#">Impresión</a>
                        <ul class="submenu">
                            <li><a href="#" onclick="addTab('Transacciones','Pinformes/ImprimeTrans.aspx',true)">Documentos</a></li>
                            <li><a href="#" onclick="addTab('Carnet','Pinformes/ImprimeCarnet.aspx',true)">Carnets</a>
                            </li>
                        </ul>
                    </li>
                    <%--<li class="" style="text-align: left"><a class="" href="#" onclick="addTab('Visualización','Pinformes/Visualizacion.aspx',true)">Informes</a>--%>
                    </li>
                    <li></li>
                </ul>
            </div>
