...
namespace Contabilidad.WebForms.App_Code.General
{
    public class BasePage : System.Web.UI.Page
    {
        ...
        public void ManejoError(Control upPanel, Type type, string mensaje, string nivel, string[] args = null)
        {
            var errores = new
            {
                mensaje = mensaje,
            ...
            clientScriptError(""" + titulo + @""",""" + errores.mensaje.Replace(Environment.NewLine, "\\r\\n").Replace("\n", "\\n").Replace("\"", "\\\"") + @""",""" + errores.nivel + @""");
        ");
