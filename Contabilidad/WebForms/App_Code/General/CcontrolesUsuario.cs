...
namespace Contabilidad.WebForms.App_Code.General
{
    public class CcontrolesUsuario
    {
        ...
        static public void InHabilitarControlesFS(ControlCollection controles)
        {
        ...
        static public void HabilitarControlesFS(ControlCollection controles)
        {
        ...
        static public void LimpiarControlesFS(ControlCollection controles)
        {
            foreach (Control objControl in controles)
            {
                if (objControl is TextBox)
