...
if((opts.position=="bottom")&&(pos.top+t_outerHeight()>$(window)._outerHeight()+$(document).scrollTop())){
pos=_1e6("top");
}
}
if(pos.left<0){
...
$(_1e4).tooltip("arrow").css("left",t_outerWidth()/2+pos.left);
pos.left=0;
}
}else{
if(pos.left+t_outerWidth()>$(window)._outerWidth()+$(document)._scrollLeft()){
if(opts.position=="right"){
pos=_1e6("left");
}else{
var left=pos.left;
pos.left=$(window)._outerWidth()+$(document)._scrollLeft()-t_outerWidth();
$(_1e4).tooltip("arrow").css("left",t_outerWidth()/2-(pos.left-left));
}
}
}
}
tcss({left:pos.left,top:pos.top,zIndex:(opts.zIndex!=undefined?opts.zIndex:($.fn.window?$.fn.window.defaults.zIndex++:""))});
opts.onPosition.call(_1e4,pos.left,pos.top);
function _1e6(_1e7){
opts.position=_1e7||"bottom";
tremoveClass("tooltip-top tooltip-bottom tooltip-left tooltip-right").addClass("tooltip-"+opts.position);
var left,top;
if(opts.trackMouse){
t=$();
...
top-=(t_outerHeight()-t._outerHeight())/2;
break;
case "left":
left-=t_outerWidth()+12+(opts.trackMouse?12:0);
top-=(t_outerHeight()-t._outerHeight())/2;
break;
case "top":
left-=(t_outerWidth()-t._outerWidth())/2;
top-=t_outerHeight()+12+(opts.trackMouse?12:0);
break;
case "bottom":
left-=(t_outerWidth()-t._outerWidth())/2;
...
var _1ec=tchildren(".tooltip-arrow-outer");
var _1ed=tchildren(".tooltip-arrow");
var bc="border-"+opts.position+"-color";
_1ec.add(_1ed).css({borderTopColor:"",borderBottomColor:"",borderLeftColor:"",borderRightColor:""});
_1ec.css(bc,tcss(bc));
_1ed.css(bc,tcss("backgroundColor"));
},opts.showDelay);
};
...
_1f3.tchildren(".tooltip-content").html(cc);
...
return $.fn.tooltmethods[_1f7](this,_1f8);
}
_1f7=_1f7||{};
return this.each(function(){
...
$.data(this,"tooltip",{options:$.extend({},$.fn.tooltdefaults,$.fn.tooltparseOptions(this),_1f7)});
init(this);
}
_1de(this);
_1eb(this);
...
$.fn.tooltmethods={options:function(jq){
...
$.fn.tooltparseOptions=function(_1fb){
var t=$(_1fb);
...
$.fn.tooltdefaults={position:"bottom",content:null,trackMouse:false,deltaX:0,deltaY:0,showEvent:"mouseenter",hideEvent:"mouseleave",showDelay:200,hideDelay:100,onShow:function(e){
},onHide:function(e){
...
if(opts.showTip){
tshow();
thtml(opts.tipFormatter.call(_9eb,opts.value));
}else{
thide();
}
if(opts.mode=="h"){
...
tattr("style",_9f1+"margin-left:"+(-Math.round(touterWidth()/2))+"px");
}else{
var _9f1="top:"+pos+"px;";
_9ee.find(".slider-handle").attr("style",_9f1);
tattr("style",_9f1+"margin-left:"+(-Math.round(touterWidth()))+"px");
}
if(_9ef!=_9ec){
