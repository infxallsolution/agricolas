<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrupoCliente.aspx.cs" Inherits="Contabilidad.WebForms.Formas.CuentasxCobrar.GrupoCliente" %>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <asp:Button ID="btnCancelar" runat="server" CssClass="botones" OnClick="nibtnCancelar_Click" Text="Cancelar" ToolTip="Cancela la operación"  />
                        <asp:Button ID="btnGuardar" runat="server" CssClass="botones" OnClick="nibtnGuardar_Click" OnClientClick="return confirmSwal(this,'Advertencia','¿Esta seguro de guardar el registro?');" Text="Guardar" ToolTip="Guarda el nuevo registro en la base de datos"  Style="height: 26px" />
                    </td>
                </tr>
            </table>
            <hr />
            ...
            <table style="width: 100%;" id="">
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 220px; text-align: left">
                                    <asp:TextBox ID="txtCodigo" runat="server" AutoPostBack="True" CssClass="input" OnTextChanged="txtCodigo_TextChanged"  Width="190px"></asp:TextBox>
                                </td>
                                <td>
                                    </td>
                            </tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left" colspan="2">
                        <select runat="server" id="selFuncionarios" class="multiselect" multiple="true" name="countries[]"  style="width: 700px; height: 200px">
                        </select></td>
                    <td></td>
                </tr>
