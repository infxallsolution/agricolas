<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cajas.aspx.cs" Inherits="Contabilidad.WebForms.Formas.CuentasxCobrar.Cajas" %>
        ...
        <form id="form1" runat="server">
            ...
            <table id="tdCampos" width="100%">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: left; width: 140px">
                        <asp:Label ID="Label4" runat="server" Text="Auxiliar"  CssClass="label"></asp:Label></td>
                    <td style="text-align: left; width: 400px">
                                <asp:DropDownList ID="ddlAuxiliar"  runat="server" Width="100%" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect"  TabIndex="14" style="left: 1px; top: 0px">
                        </asp:DropDownList>
                            </td>
                    <td></td>
                </tr>
