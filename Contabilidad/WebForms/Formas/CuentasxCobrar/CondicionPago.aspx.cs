...
{
    public partial class CondicionPago : BasePage
    {

        #region Instancias

        CcondicionPago operaciones = new CcondicionPago();
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("cCondicionPago", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
        ...
        private void Guardar()
        {
            ...
            try
            {
                ...
                this.txtCodigo.Text,
                Convert.ToDecimal(txvNoCuotas.Text),
                this.txtDescripcion.Text,
                Convert.ToDecimal(txvDiasVencimiento.Text),
                Convert.ToInt16(Session["empresa"])

            };

                switch (CentidadMetodos.EntidadInsertUpdateDelete("cCondicionPago", operacion, "ppa", objValores))
                {
                    case 0:
        ...
        protected void gvLista_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.gvLista.SelectedRow.Cells[4].Text != "&nbsp;")
                    this.txvDiasVencimiento.Text = Server.HtmlDecode(this.gvLista.SelectedRow.Cells[4].Text);

                if (this.gvLista.SelectedRow.Cells[5].Text != "&nbsp;")
                    txvNoCuotas.Text = Server.HtmlDecode(this.gvLista.SelectedRow.Cells[5].Text);


                foreach (WebControl objControl in this.gvLista.SelectedRow.Cells[6].Controls)
                {
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (CentidadMetodos.EntidadInsertUpdateDelete("cCondicionPago", operacion, "ppa", objValores) == 0)
