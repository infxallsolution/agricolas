<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Facturas.aspx.cs" Inherits="Contabilidad.WebForms.Formas.CuentasxCobrar.Facturas" %>
                                                                ...
                                                                <div style="">
                                                                    <table style="width: 100%;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 250px; text-align: left;">
                                                                                <asp:DropDownList ID="ddlSucursal" runat="server" CssClass="chzn-select-deselect"  Width="250px">
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                                    ...
                                                                                    <table style="width: 100%">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                ...
                                                                                                <asp:DropDownList ID="ddlProducto" runat="server" AutoPostBack="True" CssClass="chzn-select-deselect" OnSelectedIndexChanged="ddlProducto_SelectedIndexChanged"  Width="78%">
                                                                                                </asp:DropDownList>
                                                                                            </td>
                                                                                            ...
                                                                                            <td style="text-align: left; vertical-align: top">
                                                                                                <asp:GridView ID="gvImpuesto" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-sm  table-hover table-striped grillas" Font-Size="Small" GridLines="None" Width="95%">
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <asp:TemplateField>
                                                                                                            <ItemTemplate>
                                                                                                                <asp:HiddenField ID="hfImpuesto" runat="server"  value='<%# Eval("impuesto") %>'/>
                                                                                                                <asp:HiddenField ID="hfRetencion" runat="server"  value='<%# Eval("retencion") %>'/>
                                                                                                            </ItemTemplate>
                                                                                                        </asp:TemplateField>
                                                                                                    </Columns>
                                                                                                    <HeaderStyle CssClass="thead" />
