<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaseCliente.aspx.cs" Inherits="Contabilidad.WebForms.Formas.CuentasxCobrar.ClaseCliente" %>
        ...
        <form id="form1" runat="server">
            ...
            <table id="tdCampos" width="100%">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: left; width: 140px">
                        <asp:Label ID="Label4" runat="server" Text="Auxiliar CxC"  CssClass="label" Visible="False"></asp:Label></td>
                    <td class="auto-style1" style="text-align: left; width: 400px">
