<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MediosPago.aspx.cs" Inherits="Contabilidad.WebForms.Formas.CuentasxCobrar.MediosPago" %>
        ...
        <form id="form1" runat="server">
            ...
            <table id="tdCampos" width="100%">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: left; width: 140px">
                        <asp:Label ID="Label4" runat="server" Text="Tipo"  CssClass="label"></asp:Label></td>
                    <td style="text-align: left; width: 400px">
                                <asp:DropDownList ID="ddlTipo"  runat="server" Width="100%" data-placeholder="Seleccione una opción..." CssClass="chzn-select-deselect"  TabIndex="14">
                                    <asp:ListItem Value="CH">Cheque</asp:ListItem>
                                    <asp:ListItem Value="CO">Cosignación</asp:ListItem>
                                     <asp:ListItem Value="EF">Efectivo</asp:ListItem>
                                    <asp:ListItem Value="TB">Transferencia bancaria</asp:ListItem>
                                    <asp:ListItem Value="TC">Tarjeta credito</asp:ListItem>
                                    <asp:ListItem Value="TD">Tarjeta debito</asp:ListItem>
                        </asp:DropDownList>
                            </td>
                    <td></td>
                </tr>
