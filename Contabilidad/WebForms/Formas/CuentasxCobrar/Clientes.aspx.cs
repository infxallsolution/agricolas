    ...
    public partial class Clientes : BasePage
    {
        ...
        private void CargarCombos()
        {
            ...
            try
            {
                ...
                DataView ciudad = OrdenarEntidad(CentidadMetodos.EntidadGet("gPais", "ppa"), "descripcion", Convert.ToInt16(this.Session["empresa"]));
        ...
        private void cargarMunicipio()
        {
            try
            {
                ...
                DataView ciudad = OrdenarEntidad(CentidadMetodos.EntidadGet("gDepartamento", "ppa"), "descripcion", Convert.ToInt16(this.Session["empresa"]));
                ciudad.RowFilter = "empresa= " + Session["empresa"].ToString() + " and pais = '" + ddlPais.SelectedValue + "'";
        ...
        private void cargarciudad()
        {
            try
            {
                ...
                DataView ciudad = OrdenarEntidad(CentidadMetodos.EntidadGet("gCiudad", "ppa"), "descripcion", Convert.ToInt16(this.Session["empresa"]));
                ciudad.RowFilter = "empresa = " + Session["empresa"].ToString() + " and departamento = '" + ddlMunicipio.SelectedValue + "'";
        ...
        protected void gvLista_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                i = 14;
                foreach (WebControl c in gvLista.SelectedRow.Cells[i].Controls)
                {
                    if (c is CheckBox)
