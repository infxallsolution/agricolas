<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscarCuentas.aspx.cs" Inherits="Contabilidad.WebForms.Formas.CuentasxCobrar.BuscarCuentas" %>
    ...
    <script type="text/javascript" >
         ...
         function ActualizaCampo(indice) {
             ...
             if (controlGrilla != null) {
                 ...
                 window.opener.ActualizarCuenta(fila, nombre);
             }
