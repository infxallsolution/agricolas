...
{
    public partial class Cajas : BasePage
    {

        #region Instancias

        Ccajas operaciones = new Ccajas();
        ...
        private void CargarCombos()
        {
            try
            {
                ...
                this.ddlAuxiliar.DataSource = dvResultado;
                this.ddlAuxiliar.DataValueField = "codigo";
                this.ddlAuxiliar.DataTextField = "cadena";
                this.ddlAuxiliar.DataBind();
                this.ddlAuxiliar.Items.Insert(0, new ListItem("", ""));
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("cCaja", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
                    this.nilblInformacion.Visible = true;
                    ManejoError("Código " + this.txtCodigo.Text + " ya se encuentra registrada", "C");
        ...
        private void Guardar()
        {
            ...
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("cCaja", operacion, "ppa", objValores))
                {
                    case 0:
        ...
        protected void gvLista_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.gvLista.SelectedRow.Cells[4].Text != "&nbsp;")
                    this.ddlAuxiliar.SelectedValue = Server.HtmlDecode(this.gvLista.SelectedRow.Cells[4].Text);
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (CentidadMetodos.EntidadInsertUpdateDelete("cCaja", operacion, "ppa", objValores) == 0)
