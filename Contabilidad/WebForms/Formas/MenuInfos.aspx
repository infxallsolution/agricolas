<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuInfos.aspx.cs" Inherits="Contabilidad.WebForms.Formas.MenuInfos" %>
                ...
                <ul id="nav">
                    <li class="" style="text-align: left"><a class="" href="#">Administración</a>
                        <ul class="submenu">
                            ...
                            <li><a href="#" onclick="addTab('Centros de costo','Padministracion/CentroCosto.aspx',true);">Centros de costo</a></li>
                            <%--<li><a href="#" onclick="addTab('Lote / Costo','Padministracion/LoteCcosto.aspx',true);">Lote/costo</a></li>--%>
                            <li class="" style="text-align: left"><a class="" href="#">Impuestos/Retenciones</a>
                                <ul class="subsubmenu">
                                    <li><a href="#" onclick="addTab('ClaseIR','Padministracion/ClaseImpuestoRetencion.aspx',true);">Clases...</a></li>
                                    <li><a href="#" onclick="addTab('ConfigIR','Padministracion/ConfigIR.aspx',true);">Configuración...</a></li>
                                    <li><a href="#" onclick="addTab('ConceptosIR','Padministracion/ConceptoIR.aspx',true);">Conceptos...</a></li>
                                    <li><a href="#" onclick="addTab('Grupo IR','Padministracion/GrupoIR.aspx',true);">Grupos...</a></li>
                                </ul>
                            </li>
                            <li><a href="#" onclick="addTab('Terceros','Padministracion/Terceros.aspx',true);">Terceros</a></li>
                            <li><a href="#">Clientes</a>
                                <ul class="subsubmenu">
                                    <li><a href="#" onclick="addTab('GrupoCliente','CuentasxCobrar/GrupoCliente.aspx',true);">Grupo...</a></li>
                                    <li><a href="#" onclick="addTab('ClaseCliente','CuentasxCobrar/ClaseCliente.aspx',true);">Clases...</a></li>
                                    <li><a href="#" onclick="addTab('Clientes','CuentasxCobrar/Clientes.aspx',true);">Registro...</a></li>
                                </ul>
                            </li>
                            <li><a href="#">Proveedores</a>
                                <ul class="subsubmenu">
                                    <li><a href="#" onclick="addTab('ClaseProveedor','CuentasxPagar/ClaseProveedor.aspx',true);">Clases...</a></li>
                                    <li><a href="#" onclick="addTab('Proveedores','CuentasxPagar/Proveedor.aspx',true);">Registro...</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>

                    <li class="" style="text-align: left"><a class="" href="#">Para. Contables </a>
                        <ul class="submenu">
                            <li><a href="#" onclick="addTab('Clase','Contabilizacion/ClaseParametro.aspx',true);">Clase Conta. Nomina</a></li>
                            <li><a href="#" onclick="addTab('Par. Cont.','Contabilizacion/ParametrosGenerales.aspx',true);">Param. Contabilización</a></li>
                            <li><a href="#" onclick="addTab('Pre contabilización','Contabilizacion/Preliquidar.aspx',true);">Pre-Contabilización nómina</a></li>
                            <li><a href="#" onclick="addTab('Contabilización','Contabilizacion/Liquidacion.aspx',true);">Contabilización nómina</a></li>
                            <li><a href="#" onclick="addTab('Plano','Contabilizacion/PlanoContabilizacion.aspx',true);">Plano a otros sitemas</a></li>
                        </ul>
                    </li>
                    <li class="" style="text-align: left"><a href="#" onclick="addTab('Informes','Pinformes/Visualizacion.aspx',true);">Informes</a>
                    </li>
                </ul>
            </div>
