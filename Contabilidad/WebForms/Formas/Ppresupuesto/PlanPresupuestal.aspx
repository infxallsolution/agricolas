<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanPresupuestal.aspx.cs" Inherits="Contabilidad.WebForms.App_Code.General.PlanPresupuestal" %>
        ...
        <form id="form1" runat="server">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td style="text-align: left">
                        <asp:CheckBox
                            ID="chkActivo" runat="server" Text="Activo" Visible="False" Checked="True" />
                    </td>
                    <td></td>
                </tr>
                <tr>
