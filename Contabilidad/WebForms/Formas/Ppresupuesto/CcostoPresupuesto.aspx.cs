...
{
    public partial class CCostoPresupuesto : BasePage
    {
        #region Instancias
        ...
        private void CargarCombos()
        {
            ...
            DataView ccostospresupuesto = ccosto.RetornaMayoresCcostoPresupuesto(Convert.ToInt16(this.Session["empresa"]));
            this.ddlRaiz.DataSource = ccostospresupuesto;
        ...
        private void GetEntidad()
        {
            try
            {
                ...
                this.gvLista.DataSource = ccosto.BuscarEntidad(this.nitxtBusqueda.Text, Convert.ToInt16(this.Session["empresa"]));
