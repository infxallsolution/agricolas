<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaseImpuestoRetencion.aspx.cs" Inherits="Contabilidad.WebForms.Formas.Padministracion.ClaseImpuestoRetencion" %>
            ...
            <table style="width: 100%" id="tdCampos">
                <tr>
                    ...
                    <td  style="width: 400px; text-align: left">
                        <asp:TextBox ID="txtCodigo" runat="server" Width="200px" CssClass="input" Visible="False"></asp:TextBox>
                    </td>
                    <td></td>
                </tr>
                <tr>
                    ...
                    <td class="text-left" style="width: 400px; text-align: left">
                        <asp:TextBox ID="txtDescripcion" runat="server" onkeyup="mayuscula(this)" Width="100%" CssClass="input" Visible="False"></asp:TextBox></td>
                    <td></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="width: 150px; text-align: left">
                        <asp:Label ID="Label4" runat="server" Text="Sigla" Visible="False"></asp:Label></td>
                    <td class="text-left" style="width: 400px; text-align: left">
                        <asp:TextBox ID="txtSigla" runat="server" onkeyup="mayuscula(this)" Width="70px" CssClass="input" MaxLength="10" Visible="False"></asp:TextBox></td>
                    <td></td>
                </tr>
                <tr>
                    <td></td>
                    ...
                    <td class="text-left" style="width: 400px; text-align: left">
                        <asp:DropDownList ID="ddlTipo" runat="server" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..." TabIndex="16" Width="100%" Visible="False" AutoPostBack="True" OnSelectedIndexChanged="ddlTipo_SelectedIndexChanged">
                               <asp:ListItem Selected="True" Value="I">Impuestos</asp:ListItem>
                            <asp:ListItem Value="R">Retención</asp:ListItem>
                            <asp:ListItem Value="A">Autoretención</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td></td>
                </tr>
                ...
                <tr>
                    <td></td>
                    <td style="width: 150px; text-align: left">
                        <asp:Label ID="Label5" runat="server" Text="Referencia" Visible="False"></asp:Label></td>
                    <td style="width: 400px; text-align: left">
                        <asp:DropDownList ID="ddlRerencia" runat="server" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..." TabIndex="16" Width="100%" Visible="False"></asp:DropDownList>
                    </td>
                    <td></td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" style="text-align: center">
                        ...
                        <asp:CheckBox ID="chkProveedor" runat="server" CssClass="checkbox checkbox-primary" Text="Proveedor" Visible="False" />
                        <asp:CheckBox ID="chkCliente" runat="server" CssClass="checkbox checkbox-primary" Text="Cliente" Visible="False" />
                        <asp:CheckBox ID="chkmLLave" runat="server" CssClass="checkbox checkbox-primary" Text="Maneja llave" Visible="False" />
            ...
            <div class="tablaGrilla">
                ...
                <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-sm  table-hover table-striped grillas" OnRowDeleting="gvLista_RowDeleting" Width="100%" OnPageIndexChanging="gvLista_PageIndexChanging" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" PageSize="20" AllowPaging="True">
                    ...
                    <Columns>
                        ...
                        <asp:CheckBoxField DataField="autoRetencion" HeaderText="AutoRetención">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:CheckBoxField>
                        ...
                        <asp:CheckBoxField DataField="llaveImpuesto" HeaderText="mLlave">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:CheckBoxField>
                        <asp:CheckBoxField DataField="mProveedor" HeaderText="Proveedor">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:CheckBoxField>
                        <asp:CheckBoxField DataField="mCliente" HeaderText="Cliente">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:CheckBoxField>
