<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Terceros.aspx.cs" Inherits="Contabilidad.WebForms.Formas.Padministracion.Terceros" %>
        ...
        <form id="form1" runat="server">
            ...
            <table style="width: 100%; text-align: left;" id="tdCampos">
                <tr>
                    ...
                    <td colspan="2">
                        <asp:RadioButtonList ID="rbTipoPersona" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" OnSelectedIndexChanged="rbTipoPersona_SelectedIndexChanged" >
                            <asp:ListItem Value="1" Selected="True">Persona Natural   </asp:ListItem>
                    ...
                    <td colspan="4">
                        <table style="padding: 10px; width: 100%">
                            <tr>
                                ...
                                <td style="text-align: left; width: 200px">
                                    <asp:CheckBox CssClass="checkbox checkbox-primary" ID="chkCliente" runat="server" Text="Cliente"  TabIndex="11" />
                                </td>
                                <td style="text-align: left; width: 10px"></td>
                                <td style="text-align: left; width: 200px">
                                    <asp:CheckBox CssClass="checkbox checkbox-primary" ID="chkProveedor" runat="server" Text="Proveedor"  TabIndex="12" />
                                </td>
                                <td style="text-align: left; width: 10px"></td>
                                <td style="text-align: left; width: 200px">
                                    <asp:CheckBox CssClass="checkbox checkbox-primary" ID="chkEmpleado" runat="server" Text="Empleado"  TabIndex="13" />
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td style="text-align: left; width: 200px">
                                    <asp:CheckBox CssClass="checkbox checkbox-primary" ID="chkComercializadora" runat="server" Text="Comercializadora"  TabIndex="14" />
                                </td>
                                <td style="text-align: left; width: 10px"></td>
                                <td style="text-align: left; width: 200px">
                                    <asp:CheckBox CssClass="checkbox checkbox-primary" ID="chkAccionista" runat="server" Text="Accionista"  TabIndex="15" />
                                </td>
                                <td style="text-align: left; width: 10px"></td>
                                <td style="text-align: left; width: 200px">
                                    <asp:CheckBox CssClass="checkbox checkbox-primary" ID="chkContratista" runat="server" Text="Contratista"  TabIndex="16" />
                                </td>
                                <td style="text-align: left; width: 10px"></td>
                                <td style="text-align: left; width: 200px">
                                    <asp:CheckBox CssClass="checkbox checkbox-primary" ID="chkExtractora" runat="server" Text="Extractora"  TabIndex="17" />
                                </td>
                                <td></td>
                            </tr>
                        </table>
