<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrupoIR.aspx.cs" Inherits="Contabilidad.WebForms.Formas.Padministracion.GrupoIR" %>
            ...
            <table style="width: 100%" id="tdCampos">
                ...
                <tr>
                    ...
                    <td style="width:400px; text-align: left;" >
                        <asp:TextBox ID="txtCodigo" runat="server"  Width="150px" AutoPostBack="True" OnTextChanged="txtConcepto_TextChanged" CssClass="input" Visible="False"></asp:TextBox>
                         <asp:CheckBox ID="CheckBox1" runat="server" Visible="False"  CssClass="checkbox checkbox-primary" />
                ...
                <tr>
                    ...
                    <td  style="text-align: left;" colspan="2">
                        <asp:TextBox ID="txtObservacion" runat="server"  Width="100%" CssClass="input" Height="45px" placeholder="Observaciones, notas o comentarios..." TextMode="MultiLine" Visible="False"></asp:TextBox>
                    </td>
                    <td ></td>
                </tr>
                <tr>
                    ...
                    <td  style="vertical-align: top" colspan="2">
                        <asp:Label ID="Label5" runat="server" Text="Seleccione impuesto o retención" Visible="False" ></asp:Label>
                    </td>
                    <td ></td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: top; text-align: left;" colspan="2">
                            <select runat="server" id="selConceptos" class="multiselect" multiple="true" name="countries[]" style="width:500px; height:150px" visible="False"  >
                             </select>
                        </td>
                    <td ></td>
                </tr>
