<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EgresosDirectos.aspx.cs" Inherits="Contabilidad.WebForms.Formas.CuentasxPagar.EgresosDirectos" %>
                            ...
                            <asp:UpdatePanel ID="upCabeza" runat="server" UpdateMode="Conditional" >
                                <ContentTemplate>
                                    ...
                                    <div class="row text-left">
                                        ...
                                        <div class="col-6">
                                            <asp:DropDownList ID="ddlSucursal" runat="server" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..."  Width="100%">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="row text-left">
                                    ...
                                    <div class="row text-left">
                                        ...
                                        <div class="col-2">
                                            <asp:Label ID="lblValorPago" runat="server" Text="Valor a pagar" ></asp:Label>
                                        </div>
                                        <div class="col-2">
                                            <asp:TextBox ID="txtValorPago" runat="server" CssClass="input" onkeyup="formato_numero(this)" Width="100%" Wrap="False"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row text-left">
                                    </div>
                                    ...
                                    <div class="row text-left">
                                        ...
                                        <div class="col-10">
                                            <div class="row">
                                                ...
                                                <div class="col-2">
                                                    <div class="row">
                                                        <asp:Label ID="lblCuenta" runat="server"  Text="Cuenta contable"></asp:Label>
                                                    </div>
                                                    <div class="row">
                                                        <asp:Label ID="lblNombreCuenta" runat="server" ></asp:Label>
                                                    </div>
                                                    <div class="row">
                                                        <asp:TextBox ID="txtCuenta" runat="server" AutoPostBack="True" CssClass="input solonumero" OnTextChanged="txtCuenta_TextChanged" placeholder="Filtro auxiliar"  Width="80%"></asp:TextBox>
                                                    ...
                                                    <div class="row">
                                                        <asp:TextBox ID="txtDetalle" runat="server" CssClass="input" Height="100px" TextMode="MultiLine"  Width="100%"></asp:TextBox>
                                                ...
                                                <div class="col-7" style="max-height: 250px; overflow-y: scroll">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-sm  table-hover table-striped grillas" GridLines="None" OnRowDeleting="gvLista_RowDeleting" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" Width="100%">
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="imbEditar" runat="server" CommandName="Select" CssClass="btn btn-default btn-sm btn-primary fas fa-pencil-alt" ToolTip="Edita el registro seleccionado"></asp:LinkButton>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="imElimina0" runat="server" CommandName="Delete" CssClass="btn btn-default btn-sm btn-danger fa fa-trash " OnClientClick="return confirmSwal(this,'Advertencia','¿Desea eliminar el registro ?');" ToolTip="Elimina el registro seleccionado"></asp:LinkButton>
                                                                        </ItemTemplate>
                                                                        <ItemStyle CssClass="action-item" HorizontalAlign="Center" Width="20px" />
                                                                        <HeaderStyle CssClass="action-item" />
                                                                        <FooterStyle CssClass="action-item" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="auxiliar" FooterText="Total" HeaderText="Auxiliar">
