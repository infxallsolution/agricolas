...
namespace Contabilidad.WebForms.Formas.CuentasxPagar
{
    public partial class ClaseProveedor : BasePage
    {
        ...
        CclaseProveedor operaciones = new CclaseProveedor();
        ...
        private void EntidadKey()
        {
            ...
            try
            {
                if (CentidadMetodos.EntidadGetKey("cxpClaseProveedor", "ppa", objKey).Tables[0].Rows.Count > 0)
                {
        ...
        private void Guardar()
        {
            ...
            try
            {
                ...
                switch (CentidadMetodos.EntidadInsertUpdateDelete("cxpClaseProveedor", operacion, "ppa", objValores))
                {
                    case 0:
        ...
        protected void gvLista_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (WebControl objControl in this.gvLista.SelectedRow.Cells[7].Controls)
                {
