...
{
    public partial class Egresos : BasePage
    {
        ...
        private void totalizar()
        {
            ...
            {
                var txtvalorpago = gvr.FindControl("txtValorUnitario") as TextBox;
                totalPagar += Convert.ToDecimal(txtvalorpago.Text);
            }
        ...
        private void manejoCuenta()
        {
            try
            {
                ...
                //if (txtCuenta.Text.Trim().Length == 0 || config.Trim().Length == 0)
                //{
                ...
                //    //lblReferenciaD.Visible = false;
                //    txtTipoReferecia.Visible = false;
                //    txtNumeroReerencia.Visible = false;
                //    //lblNombreCuenta.Visible = false;
                //    //lblNombreCuenta.Text = "";
                //    //lblNombreTercero.Text = "";
                //    //txvValor.Enabled = true;
                //    //txvPorcentaje.Visible = false;
                //    txtNumeroReerencia.Visible = false;
                //    txtTipoReferecia.Visible = false;
                //    lblReferencia.Visible = false;
                //    txtNumeroReerencia.Enabled = false;
                //    txtTipoReferecia.Enabled = false;
                ...
                //        hdSA.Value = Convert.ToBoolean(aConfig[2]).ToString();
                //        hdCliente.Value = Convert.ToBoolean(aConfig[3]).ToString();
                //        hdProveedor.Value = Convert.ToBoolean(aConfig[4]).ToString();
                //        // maneja ccosto
                //        if (Convert.ToBoolean(aConfig[0]))
                //        {
                ...
                //        }
                //        //maneja tercero
                //        if (Convert.ToBoolean(aConfig[1]))
                //        {
                //            txtTercero.Visible = true;
                //            txtTercero.Text = "";
                //            txtTercero.Enabled = true;
                //            lblTercero.Visible = true;
                //            imbBuscarTercero.Visible = true;
                //            txtTercero.ReadOnly = false;
                //            txtTercero.Text = txtIdTerceroEncabezado.Text;
                //            lblNombreTercero.Text = txtNombreTerceroEncabezado.Text;
                //            manejoTercero();
                ...
                //        if (Convert.ToBoolean(aConfig[2]))
                //        {
                ...
                //            lblReferenciaD.Visible = true;
                //            txtNumeroReerencia.Visible = true;
                //            txtTipoReferecia.Visible = true;
                //            txtNumeroReerencia.Enabled = true;
                //            txtTipoReferecia.Enabled = true;
                ...
                //            txtTipoReferecia.Enabled = false;
                //        }
                //        if (Convert.ToBoolean(aConfig[5]))
                //        {
                //            lblBase.Visible = true;
                //            txvBase.Visible = true;
                //            txvPorcentaje.Visible = true;
                //            txvPorcentaje.Text = aConfig[8].ToString();
                //            txvValor.Enabled = false;
                //        }
                //        else
                //        {
                //            lblBase.Visible = false;
                //            txvBase.Visible = false;
                //            txvPorcentaje.Visible = false;
                //            txvPorcentaje.Text = "0";
                //            txvValor.Enabled = true;
                //        }

                //        if (Convert.ToBoolean(aConfig[9]))
                //        {
                //            lblReferenciaD.Visible = true;
                //            txtTipoReferecia.Visible = true;
                //            txtNumeroReerencia.Visible = true;
                //            txtTipoReferecia.Enabled = true;
                //            txtNumeroReerencia.Enabled = true;
                //            txtTipoReferecia.ReadOnly = false;
                //            txtNumeroReerencia.ReadOnly = false;
                //            lblDiasVencimiento.Visible = true;
                //            txtDiasVencimiento.Visible = true;
                //            txtDiasVencimiento.Enabled = true;
                //            txtDiasVencimiento.ReadOnly = false;
                //        }
                //        else
                //        {
                //            lblReferenciaD.Visible = false;
                ...
                //            txtTipoReferecia.Enabled = false;
                //            txtNumeroReerencia.Enabled = false;
                //            txtTipoReferecia.ReadOnly = true;
                //            txtNumeroReerencia.ReadOnly = true;
                //            lblDiasVencimiento.Visible = false;
                //            txtDiasVencimiento.Visible = false;
                //            txtDiasVencimiento.Enabled = false;
                //            txtDiasVencimiento.ReadOnly = true;
                //        }
        ...
        private void Editar()
        {
            ...
            try
            {
                using (TransactionScope ts = new TransactionScope())
                {
                    ...
                    switch (transacciones.ActualizaEncabezadoContable(txtNumero.Text, ddlTipoDocumento.SelectedValue.Trim(),
                        Convert.ToInt16(this.Session["empresa"]), this.Session["usuario"].ToString(), LimpiarCadena(txtNota.Text), fecha, fecha.Year, fecha.Month, referencia, false))
                    {
                        case 0:

                            object[] objCab = new object[] { Convert.ToInt16(Session["empresa"]), txtNumero.Text, ddlTipoDocumento.SelectedValue.Trim() };

                            switch (CentidadMetodos.EntidadInsertUpdateDelete("cTransaccionDetalle", "elimina", "ppa", objCab))
                            {
                                case 0:
                                    foreach (GridViewRow gv in gvLista.Rows)
                                    {
                                        if (gv.Cells[7].Text != "&nbsp;")
                                            valorBase = Convert.ToDecimal(gv.Cells[7].Text.Trim());
                                        if (gv.Cells[5].Text != "&nbsp;")
                                            ccosto = gv.Cells[5].Text.Trim();
                                        if (gv.Cells[9].Text != "&nbsp;")
                                            credito = Convert.ToDecimal(gv.Cells[9].Text.Trim());
                                        if (gv.Cells[2].Text != "&nbsp;")
                                            cuentaContable = gv.Cells[2].Text.Trim();
                                        if (gv.Cells[8].Text != "&nbsp;")
                                            debito = Convert.ToDecimal(gv.Cells[8].Text.Trim());
                                        if (gv.Cells[10].Text != "&nbsp;")
                                            detalle = gv.Cells[10].Text.Trim();
                                        if (gv.Cells[6].Text != "&nbsp;")
                                            referenciaD = gv.Cells[6].Text.Trim();
                                        if (gv.Cells[11].Text != "&nbsp;")
                                            registro = Convert.ToInt32(gv.Cells[11].Text.Trim());
                                        if (gv.Cells[4].Text != "&nbsp;")
                                            sucursal = gv.Cells[4].Text.Trim();
                                        if (gv.Cells[3].Text != "&nbsp;")
                                            tercero = gv.Cells[3].Text.Trim();

                                        object[] objValoresDetalle = new object[]{
                                           fecha.Year,    //@año	int
                                           valorBase,    // @base	float
                                            ccosto,   // @ccosto	varchar
                                              credito, // @credito	float
                                               0,// @creditoAlterno	float
                                               cuentaContable,// @cuenta	varchar
                                              debito, // @debito	float
                                               0,// @debitoAlterno	float
                                              Convert.ToInt32(this.Session["empresa"]), // @empresa	int
                                              fecha.Month, // @mes	int
                                              detalle, // @nota	varchar
                                              txtNumero.Text, // @numero	varchar
                                              fecha.Year.ToString() + fecha.Month.ToString(), // @periodo	int
                                             LimpiarCadena(referenciaD) , // @referencia	varchar
                                              registro, // @registro	int
                                              sucursal,// @sucursal	varchar
                                              tercero, // @tercero	int
                                             ddlTipoDocumento.SelectedValue.Trim() // @tipo	varchar
                                         };

                                        switch (CentidadMetodos.EntidadInsertUpdateDelete("cTransaccionDetalle", operacion, "ppa", objValoresDetalle))
                                        {

                                            case 1:
                                                verificaDetalle = true;
                                                ManejoError("Error al editar  el detalle de la transacción", "I");
                                                break;
                                        }
                                ...
                                case 1:
                                    verificaDetalle = true;
                                    ManejoError("Error al elminar el encabezado de la transacción.", "A");
                                    break;
                        ...
                        case 1:
                            verificaDetalle = true;
                            ManejoError("Error al editar el encabezado de la transacción.", "A");
                            break;

                    }
                    if (verificaDetalle == false)
                    {
                        ts.Complete();
                        ManejoExito("Datos Actualizados satisfactoriamente. Transacción número " + this.Session["numerotransaccion"].ToString(), "I");
        ...
        protected void Guardar()
        {
            ...
            try
            {
                using (TransactionScope ts = new TransactionScope())
                {
                    ...
                    foreach (GridViewRow gvr in gvLista.Rows)
                    {
                        var chksel = gvr.FindControl("chkSeleccion") as CheckBox;
                        if (chksel.Checked)
                        {
                            validarcuenta = true;
                            break;
                    ...
                    {
                        ManejoError("debe seleccionar una cuenta por pagar", "I");
                        return;
                    }
                    ...
                    object[] objValores = new object[] {
                                    Convert.ToDateTime(txtFecha.Text).Year,    //  @año int
                                     ...
                                     txtidBeneficiario.Text, //@beneficiario
                                      ...
                                      Convert.ToDecimal(hfTotalPagar.Value) //@valorPago  float
                };
                        ...
                        case 0:
                            ...
                            foreach (GridViewRow gvr in gvLista.Rows)
                            {
                                ...
                                if (chksel.Checked)
                                {
                                    ...
                                    if (Convert.ToDecimal(txtValorPago.Text) == Convert.ToDecimal(gvr.Cells[9].Text))
                                    {
                                        pagado = true;
                                    }
                                    ...
                                    object[] objValoresDetalle = new object[] {
                                     Convert.ToDateTime(txtFecha.Text).Year,   //@año int
                                       gvr.Cells[6].Text, //@cuentacxp  varchar
                                       null, //@cuentacxpAlt   varchar
                                     Convert.ToInt16( gvr.Cells[8].Text )  ,//@diasVencimiento
                                       Convert.ToInt16(this.Session["empresa"]), //@empresa    int
                                       Convert.ToDateTime(gvr.Cells[5].Text),  //@fechaFactura
                                       Convert.ToDateTime(txtFecha.Text).Month,  //@mes    int
                                       txtNumero.Text, //@numero varchar
                                       gvr.Cells[4].Text, //@numeroReferencia   varchar
                                       pagado,  //@pagado bit
                                       gvr.RowIndex, //@registro   varchar
                                      Convert.ToDecimal(gvr.Cells[9].Text) - Convert.ToDecimal(txtValorPago.Text),  //@Saldo  float
                                      ddlTipoDocumento.SelectedValue,  //@tipo   varchar
                                      gvr.Cells[3].Text , //@tipoReferencia varchar
                                      Convert.ToDecimal(gvr.Cells[9].Text), //@valorFactura
                                      Convert.ToDecimal(txtValorPago.Text)  //@valorPago  float
                              };
        ...
        protected void lbRegistrar_Click(object sender, EventArgs e)
        {
            ...
            decimal validarPago = 0;
            foreach (GridViewRow gvr in gvLista.Rows)
            {
                var chkseleccion = gvr.FindControl("chkSeleccion") as CheckBox;
                var txtValoru = gvr.FindControl("txtValorUnitario") as TextBox;

                validarPago += Convert.ToDecimal(txtValoru.Text);
                validarcheck = chkseleccion.Checked;

            }

            if (validarPago == 0)
            {
                ManejoError("El valor de pago debe ser mayor a 0", "I");
                return;
            }

            if (!validarcheck)
            {
                ManejoError("Debe seleccionar una documento para el egreso", "I");
                return;
        ...
        protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                int registro = Convert.ToInt16(gvLista.Rows[e.RowIndex].Cells[11].Text);
                transacciones.EliminaRegistroTransaccion(ddlTipoDocumento.SelectedValue.Trim(), txtNumero.Text, Convert.ToInt16(this.Session["empresa"]), registro);
                cargarRegistro();
                totalizar();
            }
            catch (Exception ex)
        ...
        protected void btnRegistrar_Click(object sender, EventArgs e)
        {
            //try
            //{
            //    string tercero = null, sucursal = null, ccosto = null, tiporeferencia = null, numerorefencia = null, detalle = null;
            //    decimal valorBase = 0, debito = 0, credito = 0; int registro = 0;
            //    bool anulado = false;
            //    List<Ctransacciones> listaTransaccion = null;

            //    if (txtTipoReferecia.Visible & txtTipoReferecia.Text.Trim().Length == 0)
            //    {
            //        ManejoError("Debe ingresar un tipo de docto cruce válido", "I");
            //        return;
            //    }

            //    if (txtNumeroReerencia.Visible & txtNumeroReerencia.Text.Trim().Length == 0)
            //    {
            //        ManejoError("Debe ingresar un número de docto cruce válido", "I");
            //        return;
            //    }

            //    if (txtCuenta.Text.Trim().Length == 0)
            //    {
            //        ManejoError("Debe ingresar una cuenta válida", "I");
            //        return;
            //    }

            //    if (ddlSucursal.Visible && ddlSucursal.SelectedValue.Trim().Length == 0)
            //    {
            //        ManejoError("Debe ingresar una sucursal válida", "I");
            //        return;

            //    }
            //    if (txvValor.Text.Trim().Length == 0)
            //    {
            //        ManejoError("Debe ingresar un valor válido", "I");
            //        return;
            //    }

            //    if (Convert.ToDecimal(txvValor.Text) == 0)
            //    {
            //        ManejoError("Debe ingresar un valor válido", "I");
            //        return;
            //    }

            //    if (txtDiasVencimiento.Text.Trim().Length == 0 & txtDiasVencimiento.Visible == true)
            //    {

            //        ManejoError("Debe ingresar un valor válido para los días de vencimiento", "I");
            //        return;
            //    }
            //    if (txtDiasVencimiento.Visible)
            //        if (Convert.ToDecimal(txtDiasVencimiento.Text) == 0)
            //        {
            //            ManejoError("Debe ingresar un valor válido para los días de vencimiento", "I");
            //            return;
            //        }

            //    if (txtTercero.Text.Trim().Length == 0 && txtTercero.Visible)
            //    {
            //        ManejoError("Debe ingresar un tercero válido", "I");
            //        return;
            //    }

            //    if (ddlNaturaleza.Visible)
            //    {
            //        if (ddlNaturaleza.SelectedValue.Trim().Length == 0)
            //        {
            //            ManejoError("Debe seleccionar una naturaleza valida", "I");
            //            return;
            //        }
            //    }
            ...
            //    if (txtTercero.Visible)
            //    {
            //        if (txtTercero.Text.Trim().Length > 0)
            //        {
            //            tercero = txtTercero.Text.Trim();
            //        }
            //        else
            //        {
            //            ManejoError("Debe seleccionar un tercero valido", "I");
            //            return;
            //        }
            //    }
            ...
            //        else
            //        {
            //            ManejoError("Debe seleccionar una centro de costo valido", "I");
            //            return;
            //        }
            //    }
            ...
            //    if (txvBase.Visible)
            //    {
            //        if (txvBase.Text.Length > 0)
            //        {
            //            valorBase = Convert.ToDecimal(txvBase.Text);
            //        }
            //        else
            //        {
            //            ManejoError("Debe ingresar una base válida si no maneja ingrese 0", "I");
            //            txvBase.Text = "0";
            //            return;
            //        }
            //    }

            //    if (txtNumeroReerencia.Visible)
            //    {
            //        numerorefencia = txtNumeroReerencia.Text.Trim();
            //    }

            //    if (txtTipoReferecia.Visible)
            //    {
            //        tiporeferencia = txtTipoReferecia.Text.Trim();
            //    }

            //    if (txtNumeroReerencia.Visible)
            //    {
            //        if (transacciones.verificaDocumentoCruceTercero(tiporeferencia, numerorefencia, Convert.ToInt32(this.Session["empresa"]), tercero) == 1)
            //        {
            //            ManejoError("El documento cruce ya se encuentra contabilizado para este tercero", "I");
            //            return;
            //        }
            //    }
            ...
            //    if (ddlNaturaleza.Visible)
            //    {
            //        if (ddlNaturaleza.SelectedValue == "D")
            //        {
            //            debito = Convert.ToDecimal(txvValor.Text);
            //        }
            //        else
            //        {
            //            credito = Convert.ToDecimal(txvValor.Text);
            //        }
            //    }
            ...
            //        {
            //            hdRegistro.Value = Session["registroedicion"].ToString();
            //        }
            //        else
            //        {
            //            hdRegistro.Value = (Convert.ToInt16(hdRegistro.Value) + 1).ToString();
            //        }

            //    }
            //    int validartransacicon = 0;
            //    using (TransactionScope ts = new TransactionScope())
            //    {
            //        switch (transacciones.verificaTransaccion(ddlTipoDocumento.SelectedValue, txtNumero.Text, Convert.ToInt16(Session["empresa"])))
            //        {
            //            case 0:
            //                switch (guardarEncabezado())
            //                {
            //                    case 0:
            //                        transacciones.ActualizaConsecutivo(ddlTipoDocumento.Text, Convert.ToInt16(Session["empresa"]));
            //                        switch (guardarDetalle())
            //                        {
            //                            case 1:
            //                                validartransacicon = 1;
            //                                break;
            //                            case -1:
            //                                ManejoError("hubo un proceso mal ejecutado verificar", "I");
            //                                validartransacicon = 1;
            //                                break;
            //                            case 0:
            ...
            //        else
            //        {
            //            ManejoError("Error al guardar los registros comuniquese con el administrador ", "I");
            //        }
            //    }
            ...
            //catch (Exception ex)
            //{
            //    ManejoError("Error al cargar transaccion. Correspondiente a: " + ex.Message, "C");
            //}
        ...
        protected void ddlSucursal_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (txtIdTerceroEncabezado.Text.Trim().Length == 0 || ddlSucursal.SelectedValue.Trim().Length == 0 || ddlCuentaCorriente.SelectedValue.Trim().Length == 0)
                {
                    ManejoError("Seleecioen el proveedor, sucursal o cuenta válida para continuar", "I");
                    ddlSucursal.ClearSelection();
                    gvLista.DataSource = null;
                    gvLista.DataBind();
                    return;
                }
                gvLista.DataSource = transacciones.GetCXPSaldoTercero(txtidTercero.Text, ddlSucursal.SelectedValue.Trim(), Convert.ToInt32(this.Session["empresa"]));
                gvLista.DataBind();
                ...
                {
                    upDetalle.Visible = false;
                    ManejoError("No hay cuentas por pagar pendientes para este proveedor, favor verificar", "I");
                }
            }
            catch (Exception ex)
            {
                ManejoError("Error al cargar entradas debido a: " + ex.Message, "I");
            }
        }
