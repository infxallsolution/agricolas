<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaseProveedor.aspx.cs" Inherits="Contabilidad.WebForms.Formas.CuentasxPagar.ClaseProveedor" %>
            ...
            <table id="tdCampos" width="100%">
                <tr>
                    ...
                    <td style="text-align: left; width: 400px">
                        <asp:TextBox ID="txtCodigo" runat="server"  Width="200px" AutoPostBack="True" OnTextChanged="txtConcepto_TextChanged" CssClass="input" Visible="False"></asp:TextBox></td>
                    <td></td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    <td></td>
                    <td style="text-align: left; width: 140px">
                        <asp:Label ID="Label4" runat="server" Text="Auxiliar CxP"  CssClass="label" Visible="False"></asp:Label></td>
                    <td class="auto-style1" style="text-align: left; width: 400px">
                                <asp:DropDownList ID="ddlAuxiliarCxP" runat="server" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..."  Width="100%" Visible="False"></asp:DropDownList>
                            </td>
                    <td></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="text-align: left; width: 140px">
                        <asp:Label ID="Label5" runat="server" Text="Auxiliar anticipo"  CssClass="label" Visible="False"></asp:Label></td>
                    <td class="auto-style1" style="text-align: left; width: 400px">
                                <asp:DropDownList ID="ddlAuxiliarAnticipo" runat="server" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..."  Width="100%" style="left: 0px; top: 0px" Visible="False"></asp:DropDownList>
                            </td>
                    <td></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="text-align: left; width: 140px">
                        <asp:Label ID="Label6" runat="server" Text="Pasivo estimado"  CssClass="label" Visible="False"></asp:Label></td>
                    <td class="auto-style1" style="text-align: left; width: 400px">
                                <asp:DropDownList ID="ddlAuxiliarPasivo" runat="server" CssClass="chzn-select-deselect" data-placeholder="Seleccione una opción..."  Width="100%" Visible="False"></asp:DropDownList>
                            </td>
                    <td></td>
                </tr>
                <tr>
                ...
                <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-sm  table-hover table-striped grillas" OnRowDeleting="gvLista_RowDeleting" Width="100%" OnPageIndexChanging="gvLista_PageIndexChanging" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" PageSize="20" AllowPaging="True">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="descripcion" HeaderText="Descripción">
                         ...
                         <asp:BoundField DataField="auxiliarCxP" HeaderText="AuxiliarCxP" ReadOnly="True">
                            <HeaderStyle HorizontalAlign="Left"  />
