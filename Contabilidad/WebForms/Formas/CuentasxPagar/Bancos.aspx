<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bancos.aspx.cs" Inherits="Contabilidad.WebForms.Formas.CuentasxPagar.Bancos" %>
    ...
    <div class="container">
        ...
        <form id="form1" runat="server">
            ...
            <table id="" width="100%">
                <tr>
                    <td></td>
                    <td width="250px" class="auto-style1" style="text-align: left; width: 130px">
                        <asp:Label ID="Label2" runat="server" Text="Código"  CssClass="label"></asp:Label></td>
                    <td width="350px" style="width: 400px; text-align: left">
                ...
                <tr>
                    <td></td>
                    <td class="auto-style1" style="text-align: left; width: 130px">
